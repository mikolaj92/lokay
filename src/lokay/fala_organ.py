...
ORGAN_BINDINGS: tuple[Binding, ...] = (
    ...
    Binding('prepare_delivery_closeout', handle_lanes),
    ...
    Binding('observe_delivery_replay', handle_pr_triage_department),
    Binding('close_delivery_replay', handle_pr_triage_department),
    Binding('publish_delivery_replay', handle_pr_triage_department),
    Binding('list_pr_sieve', handle_pr_triage_department),
    Binding('reconcile_pr_repair_push', handle_pr_triage_department),
    Binding('recover_repair_pre_attempt', handle_pr_triage_department),
    Binding('recover_repair_remote_unchanged', handle_pr_triage_department),
    Binding('recover_repair_confirmed_target', handle_pr_triage_department),
    Binding('recover_repair_closed_merged', handle_pr_triage_department),
    Binding('recover_repair_unavailable', handle_pr_triage_department),
    ...
    Binding('checkpoint_repair_publication', handle_repair_boundary),
