...
2. Open or reuse the stall incident, then repair in a detached recovery worktree. Do not push, open a PR, or rewrite history unless the mill recovery graph would.
3. Smallest safe source fix plus regression coverage. Do not weaken preflight, health leases, or fail-closed gates.
4. If you cannot complete the body, return {"ok":true,"department":"self_repair","route":"mill","trace":"..."} so the mill child graph runs.
