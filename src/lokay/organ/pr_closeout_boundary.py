"""Bindings for the surviving single-PR closeout path, not fleet slots."""

from typing import Any


def handle_pr_closeout(atom: str, inputs: dict[str, Any], up: dict[str, dict[str, Any]], ctx: dict[str, Any]) -> dict[str, Any] | None:
