...
def classify_technical_route(title:str,body:str)->dict[str,str]:
 text=f'{title}\n{body}'.lower()
 if ('monthly or yearly' in text or 'desired result is not specified' in text):return {'route':'park','reason':'missing_normative_decision','missing':'billing cadence: monthly or yearly'}
