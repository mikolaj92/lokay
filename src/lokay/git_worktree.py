...
def _repair_worktree_identity(
    ...
    if not repair_head_continues(runner, worktree, head, expected_sha):
...
def ensure_repair_worktree(
    ...
    *,
    ...
    if not repair_head_continues(runner, clone, remote_sha, expected):
    ...
    if branch_sha.returncode == 0:
        ...
        if not repair_head_continues(runner, clone, local_sha, expected):
