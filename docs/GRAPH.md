...
| `select_implement` | clean repos eligible for issue_to_pr (serial K budget; skip occupied). Live mill delivers every enabled repository in the configured catalog |
