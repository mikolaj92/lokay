...
| [STRATEGY_AGENT_FIRST.md](./STRATEGY_AGENT_FIRST.md) | Teza: najpierw działający Lokaj agentowy |
...
Reszta = mocne agenty SWE albo assisted coding — wartościowe mechanizmy, słabszy niż Lokaj.
