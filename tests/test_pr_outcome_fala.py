...
def test_request_changes_runs_repair_branch_not_merge(tmp_path):
    ...
    effector.write_text(
        ...
        "if a=='select_pr_review': v.update(route='publish',decision={'verdict':'request_changes'})\n"
...
def test_invalid_review_runs_one_retry_then_approve_branch(tmp_path):
    ...
    effector.write_text(
        ...
        "if a=='select_pr_review': v.update(route='publish',decision={'verdict':'approve'})\n"
...
def test_cached_sha_verdict_skips_both_review_agents(tmp_path):
    ...
    effector.write_text(
        ...
        "if a=='resolve_sha_review': v.update(route='cached',decision={'verdict':'request_changes'},merge_ok=False)\n"
        ...
        "if a=='select_pr_review': v.update(route='cached',decision={'verdict':'request_changes'},merge_ok=False)\n"
        "if a=='publish_pr_review': v['decision']={'verdict':'request_changes'}\n"
        "if a=='review_repair_gate': v['route']='repair'\n"
