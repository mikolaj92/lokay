"""apply_issue_mark in issue_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage'
_NODE_ID = 'apply_issue_mark'
_ATOM = 'apply_issue_mark'
_CONDUCTION = ['get_issue', 'finalize_issue_triage', 'select_triage_leaf']
_WHEN = {'equals': 'close', 'path': 'route', 'upstream': 'select_triage_leaf'}
