"""select_issue_evidence in issue_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage'
_NODE_ID = 'select_issue_evidence'
_ATOM = 'select_issue_evidence'
_CONDUCTION = ['select_issue_triage', 'validate_issue_evidence']
_WHEN = None
