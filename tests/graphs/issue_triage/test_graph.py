"""Native Fala host_run_package proofs for issue_triage."""
...
_EFFECTORS = [{'conduction': [], 'id': 'get_issue', 'when': None},
 ...
 {'conduction': ['finalize_issue_triage',
  ...
  'when': None}]
_MATCH = {'resolve_issue_candidate': {'route': 'evaluate'},
 'resolve_issue_hard_facts': {'route': 'agent'},
 'select_issue_triage': {'evidence_kind': 'repo_shape'},
 'select_park_stop': {'route': 'skip'},
 'select_triage_leaf': {'route': 'blocked'},
 'validate_issue_triage': {'route': 'retry'},
 'verify_issue_evidence': {'route': 'agent'}}
_MISS = {'resolve_issue_candidate': {'route': 'not-evaluate'},
 'resolve_issue_hard_facts': {'route': 'not-agent'},
 'select_issue_triage': {'evidence_kind': 'not-repo_shape'},
 'select_park_stop': {'route': 'not-skip'},
 'select_triage_leaf': {'route': 'not-blocked'},
 'validate_issue_triage': {'route': 'not-retry'},
 'verify_issue_evidence': {'route': 'not-agent'}}
_MAX_TICKS = 104
