"""collect_issue_repo_shape in issue_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage'
_NODE_ID = 'collect_issue_repo_shape'
_ATOM = 'collect_issue_repo_shape'
_CONDUCTION = ['select_issue_triage']
_WHEN = {'equals': 'repo_shape', 'path': 'evidence_kind', 'upstream': 'select_issue_triage'}
