"""validate_issue_evidence in issue_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage'
_NODE_ID = 'validate_issue_evidence'
_ATOM = 'validate_issue_evidence'
_CONDUCTION = ['verify_issue_evidence', 'issue_evidence_agent']
