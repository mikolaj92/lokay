"""collect_issue_linked_prs in issue_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage'
_NODE_ID = 'collect_issue_linked_prs'
_ATOM = 'collect_issue_linked_prs'
_CONDUCTION = ['get_issue', 'resolve_issue_candidate']
