"""collect_issue_named_paths in issue_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage'
_NODE_ID = 'collect_issue_named_paths'
_ATOM = 'collect_issue_named_paths'
_CONDUCTION = ['get_issue', 'select_issue_triage']
_WHEN = {'equals': 'named_paths', 'path': 'evidence_kind', 'upstream': 'select_issue_triage'}
