"""validate_issue_triage_retry in issue_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage'
_NODE_ID = 'validate_issue_triage_retry'
_ATOM = 'validate_issue_triage_retry'
_CONDUCTION = ['validate_issue_triage', 'issue_triage_retry_agent']
