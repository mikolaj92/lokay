"""apply_issue_skip in issue_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage'
_NODE_ID = 'apply_issue_skip'
_ATOM = 'apply_issue_skip'
_CONDUCTION = ['get_issue', 'finalize_issue_triage', 'select_triage_leaf']
_WHEN = {'equals': 'skip', 'path': 'route', 'upstream': 'select_triage_leaf'}
