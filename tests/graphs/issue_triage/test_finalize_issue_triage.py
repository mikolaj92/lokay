"""finalize_issue_triage in issue_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage'
_NODE_ID = 'finalize_issue_triage'
_ATOM = 'finalize_issue_triage'
_CONDUCTION = ['select_issue_triage', 'select_issue_evidence']
_WHEN = None
