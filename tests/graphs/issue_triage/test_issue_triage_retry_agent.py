"""issue_triage_retry_agent in issue_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage'
_NODE_ID = 'issue_triage_retry_agent'
_ATOM = 'issue_triage_retry_agent'
_CONDUCTION = ['get_issue', 'resolve_issue_hard_facts', 'map_repo', 'validate_issue_triage']
_WHEN = {'equals': 'retry', 'path': 'route', 'upstream': 'validate_issue_triage'}
