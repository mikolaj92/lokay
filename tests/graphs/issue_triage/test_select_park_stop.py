"""select_park_stop in issue_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage'
_NODE_ID = 'select_park_stop'
_ATOM = 'select_park_stop'
_CONDUCTION = ['finalize_issue_triage', 'select_triage_leaf']
_WHEN = {'equals': 'park', 'path': 'route', 'upstream': 'select_triage_leaf'}
