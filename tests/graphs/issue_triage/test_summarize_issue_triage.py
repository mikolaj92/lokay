"""summarize_issue_triage in issue_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage'
_NODE_ID = 'summarize_issue_triage'
_ATOM = 'summarize_issue_triage'
_CONDUCTION = ['finalize_issue_triage',
 'select_triage_leaf',
 'select_park_stop',
 'apply_issue_ready',
 'apply_issue_skip',
