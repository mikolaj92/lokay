"""select_issue_triage in issue_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage'
_NODE_ID = 'select_issue_triage'
_ATOM = 'select_issue_triage'
_CONDUCTION = ['resolve_issue_hard_facts', 'validate_issue_triage', 'validate_issue_triage_retry']
_WHEN = None
_REQUIRED_WHEN_FIELDS = ['evidence_kind']
