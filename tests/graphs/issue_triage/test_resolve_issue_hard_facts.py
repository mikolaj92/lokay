"""resolve_issue_hard_facts in issue_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage'
_NODE_ID = 'resolve_issue_hard_facts'
_ATOM = 'resolve_issue_hard_facts'
_CONDUCTION = ['get_issue', 'resolve_issue_candidate', 'collect_issue_linked_prs', 'collect_issue_covering_prs']
_WHEN = None
