"""validate_issue_triage in issue_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage'
_NODE_ID = 'validate_issue_triage'
_ATOM = 'validate_issue_triage'
_CONDUCTION = ['resolve_issue_hard_facts', 'issue_triage_agent']
_WHEN = None
