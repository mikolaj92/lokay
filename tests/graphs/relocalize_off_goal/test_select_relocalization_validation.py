"""select_relocalization_validation in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'select_relocalization_validation'
_ATOM = 'select_relocalization_validation'
