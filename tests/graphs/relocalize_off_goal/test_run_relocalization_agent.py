"""run_relocalization_agent in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'run_relocalization_agent'
_ATOM = 'run_relocalization_agent'
_CONDUCTION = ['inspect_relocalization_evidence', 'build_relocalization_agent_request']
_WHEN = {'equals': 'agent', 'path': 'route', 'upstream': 'build_relocalization_agent_request'}
