"""authorize_relocalization_restore in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'authorize_relocalization_restore'
_ATOM = 'authorize_relocalization_restore'
_CONDUCTION = ['classify_relocalization_residue']
_WHEN = None
