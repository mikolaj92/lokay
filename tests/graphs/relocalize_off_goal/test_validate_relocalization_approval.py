"""validate_relocalization_approval in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'validate_relocalization_approval'
_ATOM = 'validate_relocalization_approval'
_CONDUCTION = ['classify_relocalization_off_goal', 'select_relocalization_validation']
_WHEN = None
