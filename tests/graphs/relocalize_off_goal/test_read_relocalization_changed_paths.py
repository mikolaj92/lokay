"""read_relocalization_changed_paths in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'read_relocalization_changed_paths'
_ATOM = 'read_relocalization_changed_paths'
_CONDUCTION = ['inspect_relocalization_evidence']
_WHEN = None
