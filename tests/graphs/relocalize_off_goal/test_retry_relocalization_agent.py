"""retry_relocalization_agent in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'retry_relocalization_agent'
_ATOM = 'retry_relocalization_agent'
_CONDUCTION = ['inspect_relocalization_evidence', 'build_relocalization_agent_request', 'build_relocalization_retry']
_WHEN = {'equals': 'retry', 'path': 'route', 'upstream': 'build_relocalization_retry'}
