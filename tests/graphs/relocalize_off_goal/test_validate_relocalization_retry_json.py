"""validate_relocalization_retry_json in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'validate_relocalization_retry_json'
_ATOM = 'validate_relocalization_retry_json'
_CONDUCTION = ['retry_relocalization_agent']
_WHEN = None
