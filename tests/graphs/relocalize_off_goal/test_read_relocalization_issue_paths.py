"""read_relocalization_issue_paths in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'read_relocalization_issue_paths'
_ATOM = 'read_relocalization_issue_paths'
_CONDUCTION = []
_WHEN = None
