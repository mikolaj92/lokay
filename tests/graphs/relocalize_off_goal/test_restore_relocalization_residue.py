"""restore_relocalization_residue in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'restore_relocalization_residue'
_ATOM = 'restore_relocalization_residue'
_CONDUCTION = ['inspect_relocalization_evidence', 'read_relocalization_changed_paths', 'authorize_relocalization_restore']
_WHEN = {'equals': 'restore', 'path': 'route', 'upstream': 'authorize_relocalization_restore'}
