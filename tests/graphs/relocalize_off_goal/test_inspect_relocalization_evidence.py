"""inspect_relocalization_evidence in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'inspect_relocalization_evidence'
_ATOM = 'inspect_relocalization_evidence'
_CONDUCTION = []
_WHEN = None
