"""classify_relocalization_off_goal in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'classify_relocalization_off_goal'
_ATOM = 'classify_relocalization_off_goal'
_CONDUCTION = ['inspect_relocalization_evidence', 'read_relocalization_changed_paths', 'record_relocalization_restore']
_WHEN = None
