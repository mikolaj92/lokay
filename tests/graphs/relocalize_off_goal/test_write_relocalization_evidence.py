"""write_relocalization_evidence in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'write_relocalization_evidence'
_ATOM = 'write_relocalization_evidence'
_CONDUCTION = ['inspect_relocalization_evidence', 'classify_relocalization_off_goal', 'validate_relocalization_approval']
_WHEN = {'equals': 'write', 'path': 'route', 'upstream': 'validate_relocalization_approval'}
