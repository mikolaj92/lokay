"""record_relocalization_restore in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'record_relocalization_restore'
_ATOM = 'record_relocalization_restore'
_CONDUCTION = ['classify_relocalization_residue', 'authorize_relocalization_restore', 'restore_relocalization_residue']
_WHEN = None
