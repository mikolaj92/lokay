"""validate_relocalization_agent_json in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'validate_relocalization_agent_json'
_ATOM = 'validate_relocalization_agent_json'
_CONDUCTION = ['run_relocalization_agent']
_WHEN = None
