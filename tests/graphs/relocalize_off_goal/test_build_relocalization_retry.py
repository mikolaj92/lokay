"""build_relocalization_retry in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'build_relocalization_retry'
_ATOM = 'build_relocalization_retry'
_CONDUCTION = ['validate_relocalization_agent_json']
_WHEN = None
