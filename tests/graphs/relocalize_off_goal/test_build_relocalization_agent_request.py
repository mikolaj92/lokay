"""build_relocalization_agent_request in relocalize_off_goal: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'relocalize_off_goal'
_NODE_ID = 'build_relocalization_agent_request'
_ATOM = 'build_relocalization_agent_request'
_CONDUCTION = ['inspect_relocalization_evidence', 'classify_relocalization_off_goal']
_WHEN = None
