"""update_ready_hygiene_stamp in ready_hygiene: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'ready_hygiene'
_NODE_ID = 'update_ready_hygiene_stamp'
_ATOM = 'update_ready_hygiene_stamp'
_CONDUCTION = ['ready_hygiene_catalog']
_WHEN = None
