"""issue_to_pr_subflow in issue_to_pr: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr'
_NODE_ID = 'issue_to_pr_subflow'
_ATOM = 'issue_to_pr_subflow'
_CONDUCTION = ['get_issue', 'resolve_existing_delivery']
_WHEN = {'equals': 'deliver', 'path': 'route', 'upstream': 'resolve_existing_delivery'}
