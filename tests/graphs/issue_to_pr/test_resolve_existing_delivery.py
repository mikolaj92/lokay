"""resolve_existing_delivery in issue_to_pr: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr'
_NODE_ID = 'resolve_existing_delivery'
_ATOM = 'resolve_existing_delivery'
_CONDUCTION = ['resolve_implementation_issue', 'collect_existing_delivery_pr', 'collect_resumed_source']
_WHEN = None
