"""issue_to_pr_no_effect in issue_to_pr: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr'
_NODE_ID = 'issue_to_pr_no_effect'
_ATOM = 'issue_to_pr_no_effect'
_CONDUCTION = ['resolve_existing_delivery']
_WHEN = {'equals': 'no_effect', 'path': 'route', 'upstream': 'resolve_existing_delivery'}
