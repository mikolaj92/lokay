"""summarize_issue_to_pr in issue_to_pr: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr'
_NODE_ID = 'summarize_issue_to_pr'
_ATOM = 'summarize_issue_to_pr'
_CONDUCTION = ['resolve_existing_delivery', 'issue_to_pr_subflow', 'close_existing_delivery', 'issue_to_pr_no_effect']
_WHEN = None
