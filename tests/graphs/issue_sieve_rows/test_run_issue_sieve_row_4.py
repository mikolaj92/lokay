"""run_issue_sieve_row_4 in issue_sieve_rows: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_sieve_rows'
_NODE_ID = 'run_issue_sieve_row_4'
_ATOM = 'run_issue_sieve_row_4'
_CONDUCTION = ['prepare_issue_sieve', 'select_issue_sieve_slot_4', 'classify_issue_sieve_row_3']
_WHEN = {'equals': 'run', 'path': 'route', 'upstream': 'select_issue_sieve_slot_4'}
