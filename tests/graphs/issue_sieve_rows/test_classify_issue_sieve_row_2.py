"""classify_issue_sieve_row_2 in issue_sieve_rows: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_sieve_rows'
_NODE_ID = 'classify_issue_sieve_row_2'
_ATOM = 'classify_issue_sieve_row_2'
_CONDUCTION = ['prepare_issue_sieve', 'select_issue_sieve_slot_2', 'run_issue_sieve_row_2', 'classify_issue_sieve_row_1']
_WHEN = None
