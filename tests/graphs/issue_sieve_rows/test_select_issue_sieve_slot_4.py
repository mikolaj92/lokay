"""select_issue_sieve_slot_4 in issue_sieve_rows: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_sieve_rows'
_NODE_ID = 'select_issue_sieve_slot_4'
_ATOM = 'select_issue_sieve_slot_4'
_CONDUCTION = ['prepare_issue_sieve', 'classify_issue_sieve_row_3']
_WHEN = None
