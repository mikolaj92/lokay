"""run_issue_sieve_row_5 in issue_sieve_rows: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_sieve_rows'
_NODE_ID = 'run_issue_sieve_row_5'
_ATOM = 'run_issue_sieve_row_5'
_CONDUCTION = ['prepare_issue_sieve', 'select_issue_sieve_slot_5', 'classify_issue_sieve_row_4']
_WHEN = {'equals': 'run', 'path': 'route', 'upstream': 'select_issue_sieve_slot_5'}
