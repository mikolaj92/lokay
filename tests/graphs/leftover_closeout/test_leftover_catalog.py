"""leftover_catalog in leftover_closeout: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'leftover_closeout'
_NODE_ID = 'leftover_catalog'
_ATOM = 'leftover_catalog'
_CONDUCTION = ['prepare_leftover_closeout']
_WHEN = None
