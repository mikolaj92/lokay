"""update_leftover_stamp in leftover_closeout: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'leftover_closeout'
_NODE_ID = 'update_leftover_stamp'
_ATOM = 'update_leftover_stamp'
_CONDUCTION = ['leftover_catalog']
_WHEN = None
