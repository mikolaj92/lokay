"""verify_acceptance_recheck in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'verify_acceptance_recheck'
_ATOM = 'verify_acceptance_recheck'
_CONDUCTION = ['prepare_acceptance',
 'worktree_add',
 'verify_acceptance',
 'acceptance_repair_execution',
 'test_local_execution']
_WHEN = {'equals': True, 'path': 'ok', 'upstream': 'acceptance_repair_execution'}
