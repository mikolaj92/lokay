"""coding_execution in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'coding_execution'
_ATOM = 'coding_execution'
_CONDUCTION = ['get_issue',
 ...
 'cycle_start',
 'prepare_acceptance']
_WHEN = {'equals': 'ready', 'path': 'route', 'upstream': 'localize'}
