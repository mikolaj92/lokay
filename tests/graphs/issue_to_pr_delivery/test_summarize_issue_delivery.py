"""summarize_issue_delivery in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'summarize_issue_delivery'
_ATOM = 'summarize_issue_delivery'
_CONDUCTION = ['make_branch',
 'coding_execution',
