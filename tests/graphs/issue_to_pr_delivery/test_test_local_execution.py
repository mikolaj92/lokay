"""test_local_execution in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'test_local_execution'
_ATOM = 'test_local_execution'
_CONDUCTION = ['worktree_add', 'commit_implementation', 'rebase_onto_base', 'coding_execution']
_WHEN = {'equals': 'implemented', 'path': 'route', 'upstream': 'coding_execution'}
