"""verify_acceptance in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'verify_acceptance'
_ATOM = 'verify_acceptance'
_CONDUCTION = ['prepare_acceptance',
 'worktree_add',
 'finalize_local_tests',
 'test_local_execution',
 'local_repair_execution']
_WHEN = {'equals': 'publish', 'path': 'route', 'upstream': 'finalize_local_tests'}
_REQUIRED_WHEN_FIELDS = ['ok', 'route']
