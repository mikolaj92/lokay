"""resolve_implementation_issue in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'resolve_implementation_issue'
_ATOM = 'resolve_implementation_issue'
