"""select_publish_gate in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'select_publish_gate'
_ATOM = 'select_publish_gate'
_CONDUCTION = ['finalize_local_tests',
 'local_verification_terminal',
 'finalize_acceptance',
 'verify_acceptance',
 'assert_stamps_committed']
_WHEN = {'equals': 'publish', 'path': 'route', 'upstream': 'assert_stamps_committed'}
