"""relocalize_off_goal in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'relocalize_off_goal'
_ATOM = 'relocalize_off_goal'
_CONDUCTION = ['worktree_add', 'localize', 'coding_execution']
