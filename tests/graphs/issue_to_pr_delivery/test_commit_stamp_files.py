"""commit_stamp_files in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'commit_stamp_files'
_ATOM = 'commit_stamp_files'
_CONDUCTION = ['get_issue', 'worktree_add', 'list_dirty_stamp_paths', 'verify_acceptance']
_WHEN = {'equals': 'dirty', 'path': 'route', 'upstream': 'list_dirty_stamp_paths'}
