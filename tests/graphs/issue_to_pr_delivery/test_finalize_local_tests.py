"""finalize_local_tests in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'finalize_local_tests'
_ATOM = 'finalize_local_tests'
_CONDUCTION = ['select_local_test', 'local_repair_execution', 'coding_execution']
_WHEN = None
