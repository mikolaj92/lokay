"""assert_implementation_diff in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'assert_implementation_diff'
_ATOM = 'assert_real_diff'
_CONDUCTION = ['worktree_add', 'coding_execution', 'relocalize_off_goal']
