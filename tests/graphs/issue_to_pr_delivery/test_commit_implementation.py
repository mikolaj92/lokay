"""commit_implementation in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'commit_implementation'
_ATOM = 'commit_all'
_CONDUCTION = ['get_issue', 'worktree_add', 'coding_execution', 'assert_implementation_diff']
