"""assert_stamps_committed in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'assert_stamps_committed'
_ATOM = 'assert_stamps_committed'
_CONDUCTION = ['worktree_add', 'list_dirty_stamp_paths', 'commit_stamp_files', 'finalize_acceptance', 'verify_acceptance']
_WHEN = {'equals': 'publish', 'path': 'route', 'upstream': 'finalize_acceptance'}
