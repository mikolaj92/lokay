"""acceptance_repair_execution in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'acceptance_repair_execution'
_ATOM = 'local_repair_execution'
_CONDUCTION = ['get_issue', 'worktree_add', 'coding_execution', 'commit_implementation', 'verify_acceptance']
_WHEN = {'equals': 'repair', 'path': 'route', 'upstream': 'verify_acceptance'}
