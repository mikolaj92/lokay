"""finalize_acceptance in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'finalize_acceptance'
_ATOM = 'finalize_acceptance'
_CONDUCTION = ['verify_acceptance', 'acceptance_repair_execution', 'verify_acceptance_recheck']
_WHEN = {'equals': True, 'path': 'ok', 'upstream': 'verify_acceptance'}
