"""select_local_test in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'select_local_test'
_ATOM = 'select_local_test'
_CONDUCTION = ['test_local_execution', 'coding_execution']
_WHEN = None
