"""prepare_acceptance in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'prepare_acceptance'
_ATOM = 'prepare_acceptance'
_CONDUCTION = ['get_issue', 'worktree_add', 'plan_issue', 'localize']
