"""assert_real_diff in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'assert_real_diff'
_ATOM = 'assert_real_diff'
_CONDUCTION = ['worktree_add', 'finalize_local_tests', 'relocalize_off_goal', 'verify_acceptance', 'select_publish_gate']
_WHEN = {'equals': 'publish', 'path': 'route', 'upstream': 'select_publish_gate'}
