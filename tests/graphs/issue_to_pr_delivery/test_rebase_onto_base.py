"""rebase_onto_base in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'rebase_onto_base'
_ATOM = 'rebase_onto_base'
_CONDUCTION = ['worktree_add', 'commit_implementation', 'coding_execution']
