"""coding_repair_terminal in issue_to_pr_delivery: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_to_pr_delivery'
_NODE_ID = 'coding_repair_terminal'
_ATOM = 'coding_repair_terminal'
_CONDUCTION = ['finalize_local_tests']
_WHEN = {'equals': 'repair_terminal', 'path': 'route', 'upstream': 'finalize_local_tests'}
