"""summarize_stale_worktree_reap in stale_worktree_reap: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'stale_worktree_reap'
_NODE_ID = 'summarize_stale_worktree_reap'
_ATOM = 'summarize_stale_worktree_reap'
_CONDUCTION = ['collect_stale_worktree_candidates', 'stale_worktree_catalog']
_WHEN = None
