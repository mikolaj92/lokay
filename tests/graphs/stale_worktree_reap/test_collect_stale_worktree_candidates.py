"""collect_stale_worktree_candidates in stale_worktree_reap: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'stale_worktree_reap'
_NODE_ID = 'collect_stale_worktree_candidates'
_ATOM = 'collect_stale_worktree_candidates'
_CONDUCTION = []
_WHEN = None
