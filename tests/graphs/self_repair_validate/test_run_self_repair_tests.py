"""run_self_repair_tests in self_repair_validate: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_validate'
_NODE_ID = 'run_self_repair_tests'
_ATOM = 'run_self_repair_tests'
_CONDUCTION = ['select_self_repair_identity_gate', 'verify_self_repair_candidate_identity']
_WHEN = None
