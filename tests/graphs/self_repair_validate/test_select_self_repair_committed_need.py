"""select_self_repair_committed_need in self_repair_validate: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_validate'
_NODE_ID = 'select_self_repair_committed_need'
_ATOM = 'select_self_repair_committed_need'
_CONDUCTION = ['check_self_repair_tracked_cached']
