"""check_self_repair_tracked_cached in self_repair_validate: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_validate'
_NODE_ID = 'check_self_repair_tracked_cached'
_ATOM = 'check_self_repair_tracked_cached'
_CONDUCTION = ['check_self_repair_tracked_working']
_WHEN = {'equals': True, 'path': 'ok', 'upstream': 'check_self_repair_tracked_working'}
