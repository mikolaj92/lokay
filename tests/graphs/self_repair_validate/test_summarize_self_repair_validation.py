"""summarize_self_repair_validation in self_repair_validate: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_validate'
_NODE_ID = 'summarize_self_repair_validation'
_ATOM = 'summarize_self_repair_validation'
_CONDUCTION = ['recheck_self_repair_identity']
_WHEN = {'equals': True, 'path': 'ok', 'upstream': 'recheck_self_repair_identity'}
