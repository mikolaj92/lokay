"""check_self_repair_tracked_committed in self_repair_validate: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_validate'
_NODE_ID = 'check_self_repair_tracked_committed'
_ATOM = 'check_self_repair_tracked_committed'
_CONDUCTION = ['select_self_repair_committed_need']
_WHEN = {'equals': 'has_base', 'path': 'route', 'upstream': 'select_self_repair_committed_need'}
