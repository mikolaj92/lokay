"""check_self_repair_tracked_working in self_repair_validate: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_validate'
_NODE_ID = 'check_self_repair_tracked_working'
_ATOM = 'check_self_repair_tracked_working'
_CONDUCTION = ['self_repair_untracked_catalog']
_WHEN = {'equals': True, 'path': 'ok', 'upstream': 'self_repair_untracked_catalog'}
