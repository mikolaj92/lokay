"""select_self_repair_committed_gate in self_repair_validate: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_validate'
_NODE_ID = 'select_self_repair_committed_gate'
_ATOM = 'select_self_repair_committed_gate'
_CONDUCTION = ['check_self_repair_tracked_cached', 'check_self_repair_tracked_committed']
_WHEN = {'equals': True, 'path': 'ok', 'upstream': 'check_self_repair_tracked_cached'}
_REQUIRED_WHEN_FIELDS = ['ok']
