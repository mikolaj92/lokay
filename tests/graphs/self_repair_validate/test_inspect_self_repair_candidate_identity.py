"""inspect_self_repair_candidate_identity in self_repair_validate: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_validate'
_NODE_ID = 'inspect_self_repair_candidate_identity'
_ATOM = 'inspect_self_repair_candidate_identity'
_CONDUCTION = ['validate_self_repair_identity_request']
_WHEN = {'equals': 'inspect', 'path': 'route', 'upstream': 'validate_self_repair_identity_request'}
