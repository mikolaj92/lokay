"""classify_self_repair_candidate_diff in self_repair_validate: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_validate'
_NODE_ID = 'classify_self_repair_candidate_diff'
_ATOM = 'classify_self_repair_candidate_diff'
_CONDUCTION = ['read_self_repair_candidate_state']
_WHEN = None
