"""list_self_repair_untracked_paths in self_repair_validate: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_validate'
_NODE_ID = 'list_self_repair_untracked_paths'
_ATOM = 'list_self_repair_untracked_paths'
_CONDUCTION = ['run_self_repair_tests']
_WHEN = {'equals': True, 'path': 'ok', 'upstream': 'run_self_repair_tests'}
