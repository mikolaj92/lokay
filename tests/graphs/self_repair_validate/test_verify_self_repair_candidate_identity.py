"""verify_self_repair_candidate_identity in self_repair_validate: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_validate'
_NODE_ID = 'verify_self_repair_candidate_identity'
_ATOM = 'verify_self_repair_candidate_identity'
_CONDUCTION = ['select_self_repair_identity_gate']
_WHEN = {'equals': 'identity', 'path': 'route', 'upstream': 'select_self_repair_identity_gate'}
