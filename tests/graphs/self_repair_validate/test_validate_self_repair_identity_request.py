"""validate_self_repair_identity_request in self_repair_validate: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_validate'
_NODE_ID = 'validate_self_repair_identity_request'
_ATOM = 'validate_self_repair_identity_request'
_CONDUCTION = ['classify_self_repair_candidate_diff']
_WHEN = None
