"""recheck_self_repair_identity in self_repair_validate: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_validate'
_NODE_ID = 'recheck_self_repair_identity'
_ATOM = 'recheck_self_repair_identity'
_CONDUCTION = ['select_self_repair_committed_gate']
_WHEN = {'equals': True, 'path': 'ok', 'upstream': 'select_self_repair_committed_gate'}
