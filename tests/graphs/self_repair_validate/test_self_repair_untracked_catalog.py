"""self_repair_untracked_catalog in self_repair_validate: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_validate'
_NODE_ID = 'self_repair_untracked_catalog'
_ATOM = 'self_repair_untracked_catalog'
_CONDUCTION = ['list_self_repair_untracked_paths']
_WHEN = {'equals': True, 'path': 'ok', 'upstream': 'list_self_repair_untracked_paths'}
