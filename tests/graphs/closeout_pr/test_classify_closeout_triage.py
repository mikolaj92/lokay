"""classify_closeout_triage in closeout_pr: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'closeout_pr'
_NODE_ID = 'classify_closeout_triage'
_ATOM = 'classify_closeout_triage'
_CONDUCTION = ['route_closeout_checks', 'run_closeout_triage']
_WHEN = None
