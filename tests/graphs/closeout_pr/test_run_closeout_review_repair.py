"""run_closeout_review_repair in closeout_pr: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'closeout_pr'
_NODE_ID = 'run_closeout_review_repair'
_ATOM = 'run_closeout_review_repair'
_CONDUCTION = ['classify_closeout_gate', 'authorize_closeout_review_repair']
_WHEN = {'equals': 'repair', 'path': 'route', 'upstream': 'authorize_closeout_review_repair'}
