"""read_closeout_issue in closeout_pr: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'closeout_pr'
_NODE_ID = 'read_closeout_issue'
_ATOM = 'read_closeout_issue'
_CONDUCTION = ['inspect_closeout_pr']
_WHEN = None
