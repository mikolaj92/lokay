"""authorize_closeout_review_repair in closeout_pr: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'closeout_pr'
_NODE_ID = 'authorize_closeout_review_repair'
_ATOM = 'authorize_closeout_review_repair'
