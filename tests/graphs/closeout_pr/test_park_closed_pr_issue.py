"""park_closed_pr_issue in closeout_pr: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'closeout_pr'
_NODE_ID = 'park_closed_pr_issue'
_ATOM = 'park_closed_pr_issue'
_CONDUCTION = ['classify_closeout_gate']
_WHEN = {'equals': 'issue_closed', 'path': 'route', 'upstream': 'classify_closeout_gate'}
