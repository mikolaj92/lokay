"""route_closeout_checks in closeout_pr: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'closeout_pr'
_NODE_ID = 'route_closeout_checks'
_ATOM = 'route_closeout_checks'
_CONDUCTION = ['classify_closeout_gate', 'read_closeout_checks']
_WHEN = None
