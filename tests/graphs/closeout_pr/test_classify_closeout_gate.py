"""classify_closeout_gate in closeout_pr: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'closeout_pr'
_NODE_ID = 'classify_closeout_gate'
_ATOM = 'classify_closeout_gate'
_CONDUCTION = ['inspect_closeout_pr', 'read_closeout_issue']
_WHEN = None
