"""select_closeout_park_result in closeout_pr: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'closeout_pr'
_NODE_ID = 'select_closeout_park_result'
_ATOM = 'select_closeout_park_result'
_CONDUCTION = ['park_closed_pr_issue', 'park_delivered_pr_issue']
_WHEN = None
