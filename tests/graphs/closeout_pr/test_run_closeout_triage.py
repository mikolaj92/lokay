"""run_closeout_triage in closeout_pr: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'closeout_pr'
_NODE_ID = 'run_closeout_triage'
_ATOM = 'run_closeout_triage'
_CONDUCTION = ['classify_closeout_gate', 'route_closeout_checks']
_WHEN = {'equals': 'triage', 'path': 'route', 'upstream': 'route_closeout_checks'}
