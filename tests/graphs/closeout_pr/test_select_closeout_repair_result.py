"""select_closeout_repair_result in closeout_pr: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'closeout_pr'
_NODE_ID = 'select_closeout_repair_result'
_ATOM = 'select_closeout_repair_result'
_CONDUCTION = ['authorize_closeout_repair',
 'run_closeout_repair',
