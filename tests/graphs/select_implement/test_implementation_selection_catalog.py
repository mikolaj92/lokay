"""implementation_selection_catalog in select_implement: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'select_implement'
_NODE_ID = 'implementation_selection_catalog'
_ATOM = 'implementation_selection_catalog'
_CONDUCTION = ['prepare_implementation_selection']
_WHEN = None
