"""prepare_implementation_selection in select_implement: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'select_implement'
_NODE_ID = 'prepare_implementation_selection'
_ATOM = 'prepare_implementation_selection'
_CONDUCTION = []
_WHEN = None
