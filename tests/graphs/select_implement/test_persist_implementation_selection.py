"""persist_implementation_selection in select_implement: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'select_implement'
_NODE_ID = 'persist_implementation_selection'
_ATOM = 'persist_implementation_selection'
_CONDUCTION = ['implementation_selection_catalog']
_WHEN = None
