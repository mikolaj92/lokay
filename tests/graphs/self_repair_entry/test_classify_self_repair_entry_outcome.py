"""classify_self_repair_entry_outcome in self_repair_entry: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_entry'
_NODE_ID = 'classify_self_repair_entry_outcome'
_ATOM = 'classify_self_repair_entry_outcome'
_CONDUCTION = ['record_authored_self_repair']
_WHEN = None
