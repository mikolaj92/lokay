"""run_authored_self_repair in self_repair_entry: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_entry'
_NODE_ID = 'run_authored_self_repair'
_ATOM = 'run_authored_self_repair'
_CONDUCTION = ['prepare_self_repair_entry', 'classify_self_repair_entry', 'record_self_repair_entry_start']
_WHEN = {'equals': 'run', 'path': 'route', 'upstream': 'classify_self_repair_entry'}
