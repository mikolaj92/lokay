"""record_self_repair_entry_start in self_repair_entry: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_entry'
_NODE_ID = 'record_self_repair_entry_start'
_ATOM = 'record_self_repair_entry_start'
_CONDUCTION = ['prepare_self_repair_entry', 'classify_self_repair_entry']
