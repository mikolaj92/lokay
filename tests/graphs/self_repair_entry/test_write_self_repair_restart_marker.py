"""write_self_repair_restart_marker in self_repair_entry: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_entry'
_NODE_ID = 'write_self_repair_restart_marker'
_ATOM = 'write_self_repair_restart_marker'
_CONDUCTION = ['prepare_self_repair_entry', 'classify_self_repair_entry_outcome']
_WHEN = {'equals': 'restart', 'path': 'route', 'upstream': 'classify_self_repair_entry_outcome'}
