"""self_repair_entry_terminal in self_repair_entry: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_entry'
_NODE_ID = 'self_repair_entry_terminal'
_ATOM = 'self_repair_entry_terminal'
_CONDUCTION = ['select_self_repair_entry_result', 'record_self_repair_entry_success', 'record_self_repair_entry_failure']
_WHEN = None
