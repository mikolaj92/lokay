"""select_self_repair_entry_result in self_repair_entry: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_entry'
_NODE_ID = 'select_self_repair_entry_result'
_ATOM = 'select_self_repair_entry_result'
_CONDUCTION = ['prepare_self_repair_entry',
