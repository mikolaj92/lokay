"""record_self_repair_entry_success in self_repair_entry: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_entry'
_NODE_ID = 'record_self_repair_entry_success'
_ATOM = 'record_self_repair_entry_success'
_CONDUCTION = ['prepare_self_repair_entry', 'select_self_repair_entry_result']
_WHEN = {'equals': 'success', 'path': 'route', 'upstream': 'select_self_repair_entry_result'}
