"""record_dispatch_success in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'record_dispatch_success'
_ATOM = 'record_dispatch_success'
_CONDUCTION = ['select_launch_route']
_WHEN = {'equals': 'started', 'path': 'route', 'upstream': 'select_launch_route'}
