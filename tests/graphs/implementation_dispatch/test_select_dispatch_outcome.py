"""select_dispatch_outcome in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'select_dispatch_outcome'
_ATOM = 'select_dispatch_outcome'
_CONDUCTION = ['record_dispatch_success', 'record_dispatch_failure']
_WHEN = None
_REQUIRED_WHEN_FIELDS = ['route', 'stuck_changed']
