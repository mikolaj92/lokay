"""drop_stale_implementation_candidate in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'drop_stale_implementation_candidate'
_ATOM = 'drop_stale_implementation_candidate'
_CONDUCTION = ['select_ready_outcome']
_WHEN = {'equals': 'stale', 'path': 'route', 'upstream': 'select_ready_outcome'}
