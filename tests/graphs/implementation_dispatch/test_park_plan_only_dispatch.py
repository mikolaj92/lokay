"""park_plan_only_dispatch in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'park_plan_only_dispatch'
_ATOM = 'park_plan_only_dispatch'
_CONDUCTION = ['select_blocked_dispatch']
_WHEN = {'equals': 'park', 'path': 'route', 'upstream': 'select_blocked_dispatch'}
