"""keep_implementation_candidate in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'keep_implementation_candidate'
_ATOM = 'keep_implementation_candidate'
_CONDUCTION = ['select_mutex_outcome']
_WHEN = {'equals': 'keep', 'path': 'route', 'upstream': 'select_mutex_outcome'}
