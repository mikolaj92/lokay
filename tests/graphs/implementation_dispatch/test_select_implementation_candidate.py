"""select_implementation_candidate in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'select_implementation_candidate'
_ATOM = 'select_implementation_candidate'
_CONDUCTION = []
_WHEN = None
