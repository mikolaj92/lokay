"""persist_blocked_dispatch in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'persist_blocked_dispatch'
_ATOM = 'persist_blocked_dispatch'
_CONDUCTION = ['label_blocked_dispatch']
_WHEN = None
