"""keep_busy_launch in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'keep_busy_launch'
_ATOM = 'keep_busy_launch'
_CONDUCTION = ['select_launch_route']
_WHEN = {'equals': 'busy', 'path': 'route', 'upstream': 'select_launch_route'}
