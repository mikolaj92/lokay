"""inspect_implementation_mutex in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'inspect_implementation_mutex'
_ATOM = 'inspect_implementation_mutex'
_CONDUCTION = ['select_implementation_candidate']
_WHEN = {'equals': 'candidate', 'path': 'route', 'upstream': 'select_implementation_candidate'}
