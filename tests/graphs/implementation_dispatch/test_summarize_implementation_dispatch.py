"""summarize_implementation_dispatch in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'summarize_implementation_dispatch'
_ATOM = 'summarize_implementation_dispatch'
