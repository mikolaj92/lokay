"""write_dispatch_receipt in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'write_dispatch_receipt'
_ATOM = 'write_dispatch_receipt'
_CONDUCTION = ['select_dispatch_outcome']
_WHEN = {'equals': 'receipt', 'path': 'route', 'upstream': 'select_dispatch_outcome'}
