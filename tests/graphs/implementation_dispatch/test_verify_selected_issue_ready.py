"""verify_selected_issue_ready in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'verify_selected_issue_ready'
_ATOM = 'verify_selected_issue_ready'
_CONDUCTION = ['select_mutex_outcome']
_WHEN = {'equals': 'free', 'path': 'route', 'upstream': 'select_mutex_outcome'}
