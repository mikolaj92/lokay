"""persist_dispatch_stuck in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'persist_dispatch_stuck'
_ATOM = 'persist_dispatch_stuck'
_CONDUCTION = ['select_dispatch_outcome']
_WHEN = {'equals': True, 'path': 'stuck_changed', 'upstream': 'select_dispatch_outcome'}
