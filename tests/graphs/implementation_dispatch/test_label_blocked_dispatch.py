"""label_blocked_dispatch in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'label_blocked_dispatch'
_ATOM = 'label_blocked_dispatch'
_CONDUCTION = ['select_dispatch_outcome']
_WHEN = {'equals': 'blocked', 'path': 'route', 'upstream': 'select_dispatch_outcome'}
