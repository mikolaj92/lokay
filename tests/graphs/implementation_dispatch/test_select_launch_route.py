"""select_launch_route in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'select_launch_route'
_ATOM = 'select_launch_route'
_CONDUCTION = ['select_ready_outcome', 'launch_issue_to_pr']
_WHEN = None
