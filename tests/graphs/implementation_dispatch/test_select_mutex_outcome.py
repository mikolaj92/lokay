"""select_mutex_outcome in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'select_mutex_outcome'
_ATOM = 'select_mutex_outcome'
_CONDUCTION = ['select_implementation_candidate', 'inspect_implementation_mutex']
_WHEN = None
