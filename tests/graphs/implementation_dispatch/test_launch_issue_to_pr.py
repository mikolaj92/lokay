"""launch_issue_to_pr in implementation_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'implementation_dispatch'
_NODE_ID = 'launch_issue_to_pr'
_ATOM = 'launch_issue_to_pr'
_CONDUCTION = ['select_ready_outcome']
_WHEN = {'equals': 'ready', 'path': 'route', 'upstream': 'select_ready_outcome'}
