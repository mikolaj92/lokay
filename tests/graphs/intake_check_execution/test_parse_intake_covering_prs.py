"""parse_intake_covering_prs in intake_check_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'intake_check_execution'
_NODE_ID = 'parse_intake_covering_prs'
_ATOM = 'parse_intake_covering_prs'
_CONDUCTION = ['prepare_intake_check', 'classify_intake_check_route']
