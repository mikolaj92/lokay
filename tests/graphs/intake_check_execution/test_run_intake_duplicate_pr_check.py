"""run_intake_duplicate_pr_check in intake_check_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'intake_check_execution'
_NODE_ID = 'run_intake_duplicate_pr_check'
_ATOM = 'run_intake_duplicate_pr_check'
_CONDUCTION = ['read_intake_check_issue', 'parse_intake_covering_prs', 'classify_intake_check_route']
_WHEN = {'equals': 'duplicate_ai_pr', 'path': 'route', 'upstream': 'classify_intake_check_route'}
