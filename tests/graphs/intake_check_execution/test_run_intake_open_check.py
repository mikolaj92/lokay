"""run_intake_open_check in intake_check_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'intake_check_execution'
_NODE_ID = 'run_intake_open_check'
_ATOM = 'run_intake_open_check'
_CONDUCTION = ['read_intake_check_issue', 'classify_intake_check_route']
_WHEN = {'equals': 'open', 'path': 'route', 'upstream': 'classify_intake_check_route'}
