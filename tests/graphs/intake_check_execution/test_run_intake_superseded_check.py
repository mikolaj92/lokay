"""run_intake_superseded_check in intake_check_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'intake_check_execution'
_NODE_ID = 'run_intake_superseded_check'
_ATOM = 'run_intake_superseded_check'
_CONDUCTION = ['prepare_intake_check', 'read_intake_check_issue', 'classify_intake_check_route']
_WHEN = {'equals': 'superseded', 'path': 'route', 'upstream': 'classify_intake_check_route'}
