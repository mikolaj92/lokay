"""probe_intake_check_shape in intake_check_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'intake_check_execution'
_NODE_ID = 'probe_intake_check_shape'
_ATOM = 'probe_intake_check_shape'
_CONDUCTION = ['resolve_intake_check_clone', 'classify_intake_check_route']
