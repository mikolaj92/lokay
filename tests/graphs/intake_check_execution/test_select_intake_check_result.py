"""select_intake_check_result in intake_check_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'intake_check_execution'
_NODE_ID = 'select_intake_check_result'
_ATOM = 'select_intake_check_result'
_CONDUCTION = ['run_intake_open_check',
