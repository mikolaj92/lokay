"""run_intake_satisfied_check in intake_check_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'intake_check_execution'
_NODE_ID = 'run_intake_satisfied_check'
_ATOM = 'run_intake_satisfied_check'
_CONDUCTION = ['read_intake_check_issue', 'resolve_intake_check_clone', 'classify_intake_check_route']
_WHEN = {'equals': 'satisfied', 'path': 'route', 'upstream': 'classify_intake_check_route'}
