"""read_intake_check_issue in intake_check_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'intake_check_execution'
_NODE_ID = 'read_intake_check_issue'
_ATOM = 'read_intake_check_issue'
_CONDUCTION = ['prepare_intake_check']
_WHEN = None
