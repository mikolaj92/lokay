"""write_issue_approach in plan_issue_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'plan_issue_execution'
_NODE_ID = 'write_issue_approach'
_ATOM = 'write_issue_approach'
_CONDUCTION = ['prepare_issue_plan_request', 'build_issue_approach', 'authorize_issue_plan_write']
_WHEN = {'equals': 'write', 'path': 'route', 'upstream': 'authorize_issue_plan_write'}
