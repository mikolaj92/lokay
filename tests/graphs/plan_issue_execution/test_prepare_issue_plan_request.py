"""prepare_issue_plan_request in plan_issue_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'plan_issue_execution'
_NODE_ID = 'prepare_issue_plan_request'
_ATOM = 'prepare_issue_plan_request'
_CONDUCTION = []
_WHEN = None
