"""record_issue_approach_write in plan_issue_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'plan_issue_execution'
_NODE_ID = 'record_issue_approach_write'
_ATOM = 'record_issue_approach_write'
_CONDUCTION = ['authorize_issue_plan_write', 'write_issue_approach']
_WHEN = None
