"""clear_harvest_closed_rows in child_harvest: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'child_harvest'
_NODE_ID = 'clear_harvest_closed_rows'
_ATOM = 'clear_harvest_closed_rows'
_CONDUCTION = ['harvest_catalog']
_WHEN = None
