"""reconcile_dead_child_receipts in child_harvest: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'child_harvest'
_NODE_ID = 'reconcile_dead_child_receipts'
_ATOM = 'reconcile_dead_child_receipts'
_CONDUCTION = ['collect_child_harvest_facts']
_WHEN = None
