"""child_harvest_terminal in child_harvest: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'child_harvest'
_NODE_ID = 'child_harvest_terminal'
_ATOM = 'child_harvest_terminal'
_CONDUCTION = ['clear_harvest_cycle_starts']
_WHEN = None
