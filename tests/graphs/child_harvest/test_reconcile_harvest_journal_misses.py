"""reconcile_harvest_journal_misses in child_harvest: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'child_harvest'
_NODE_ID = 'reconcile_harvest_journal_misses'
_ATOM = 'reconcile_harvest_journal_misses'
_CONDUCTION = ['reconcile_dead_child_receipts']
_WHEN = None
