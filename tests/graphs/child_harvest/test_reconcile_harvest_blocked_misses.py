"""reconcile_harvest_blocked_misses in child_harvest: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'child_harvest'
_NODE_ID = 'reconcile_harvest_blocked_misses'
_ATOM = 'reconcile_harvest_blocked_misses'
_CONDUCTION = ['reconcile_harvest_deliveries']
_WHEN = None
