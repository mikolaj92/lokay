"""harvest_catalog in child_harvest: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'child_harvest'
_NODE_ID = 'harvest_catalog'
_ATOM = 'harvest_catalog'
_CONDUCTION = ['reconcile_harvest_blocked_misses']
_WHEN = None
