"""reconcile_harvest_deliveries in child_harvest: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'child_harvest'
_NODE_ID = 'reconcile_harvest_deliveries'
_ATOM = 'reconcile_harvest_deliveries'
_CONDUCTION = ['reconcile_harvest_journal_misses']
_WHEN = None
