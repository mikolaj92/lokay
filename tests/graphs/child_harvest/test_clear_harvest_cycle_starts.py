"""clear_harvest_cycle_starts in child_harvest: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'child_harvest'
_NODE_ID = 'clear_harvest_cycle_starts'
_ATOM = 'clear_harvest_cycle_starts'
_CONDUCTION = ['drop_harvest_out_of_scope']
_WHEN = None
