"""recovery_factory in daemon_cycle: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'daemon_cycle'
_NODE_ID = 'recovery_factory'
_ATOM = 'recovery_factory'
_CONDUCTION = ['select_repair_route', 'recovery_run_self_repair']
_WHEN = {'equals': 'factory', 'path': 'route', 'upstream': 'select_repair_route'}
