"""recovery_run_self_repair in daemon_cycle: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'daemon_cycle'
_NODE_ID = 'recovery_run_self_repair'
_ATOM = 'recovery_run_self_repair'
_CONDUCTION = ['select_repair_route', 'recovery_incident']
_WHEN = {'equals': 'repair', 'path': 'route', 'upstream': 'select_repair_route'}
