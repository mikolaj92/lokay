...
The expanded Fala catalog is the authority for generated graph suites. Native tests drive `host_run_package` with a Fala fixture organ. `host_drive` with pre-registered outputs is not a `when` proof.
