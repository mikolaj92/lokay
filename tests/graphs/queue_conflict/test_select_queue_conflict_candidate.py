"""select_queue_conflict_candidate in queue_conflict: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'queue_conflict'
_NODE_ID = 'select_queue_conflict_candidate'
_ATOM = 'select_queue_conflict_candidate'
_CONDUCTION = []
_WHEN = None
