"""select_queue_tracker in queue_conflict: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'queue_conflict'
_NODE_ID = 'select_queue_tracker'
_ATOM = 'select_queue_tracker'
_CONDUCTION = ['select_queue_conflict_outcome', 'remove_queue_ready_label']
_WHEN = None
