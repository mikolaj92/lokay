"""add_queue_tracker_label in queue_conflict: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'queue_conflict'
_NODE_ID = 'add_queue_tracker_label'
_ATOM = 'add_queue_tracker_label'
_CONDUCTION = ['select_queue_tracker']
_WHEN = {'equals': 'tracker', 'path': 'route', 'upstream': 'select_queue_tracker'}
