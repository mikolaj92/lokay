"""advance_implementation_selection in queue_conflict: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'queue_conflict'
_NODE_ID = 'advance_implementation_selection'
_ATOM = 'advance_implementation_selection'
_CONDUCTION = ['record_queue_conflict']
_WHEN = None
