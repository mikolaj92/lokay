"""check_queue_covering_pr in queue_conflict: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'queue_conflict'
_NODE_ID = 'check_queue_covering_pr'
_ATOM = 'check_queue_covering_pr'
_CONDUCTION = ['select_queue_conflict_candidate']
_WHEN = {'equals': 'candidate', 'path': 'route', 'upstream': 'select_queue_conflict_candidate'}
