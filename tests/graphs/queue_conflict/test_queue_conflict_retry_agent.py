"""queue_conflict_retry_agent in queue_conflict: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'queue_conflict'
_NODE_ID = 'queue_conflict_retry_agent'
_ATOM = 'queue_conflict_retry_agent'
_CONDUCTION = ['validate_queue_conflict', 'select_queue_conflict_gate']
_WHEN = {'equals': 'retry', 'path': 'route', 'upstream': 'validate_queue_conflict'}
