"""select_queue_conflict_gate in queue_conflict: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'queue_conflict'
_NODE_ID = 'select_queue_conflict_gate'
_ATOM = 'select_queue_conflict_gate'
_CONDUCTION = ['select_queue_conflict_candidate', 'check_queue_covering_pr']
_WHEN = None
