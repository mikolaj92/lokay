"""record_queue_conflict in queue_conflict: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'queue_conflict'
_NODE_ID = 'record_queue_conflict'
_ATOM = 'record_queue_conflict'
_CONDUCTION = ['select_queue_conflict_outcome', 'remove_queue_ready_label', 'add_queue_tracker_label']
_WHEN = None
