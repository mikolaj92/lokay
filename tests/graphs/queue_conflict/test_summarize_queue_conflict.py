"""summarize_queue_conflict in queue_conflict: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'queue_conflict'
_NODE_ID = 'summarize_queue_conflict'
_ATOM = 'summarize_queue_conflict'
_CONDUCTION = ['select_queue_conflict_candidate', 'record_queue_conflict', 'advance_implementation_selection']
_WHEN = None
