"""validate_queue_conflict_retry in queue_conflict: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'queue_conflict'
_NODE_ID = 'validate_queue_conflict_retry'
_ATOM = 'validate_queue_conflict_retry'
_CONDUCTION = ['queue_conflict_retry_agent']
_WHEN = None
