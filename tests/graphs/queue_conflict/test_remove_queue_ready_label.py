"""remove_queue_ready_label in queue_conflict: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'queue_conflict'
_NODE_ID = 'remove_queue_ready_label'
_ATOM = 'remove_queue_ready_label'
_CONDUCTION = ['select_queue_conflict_outcome']
_WHEN = {'equals': 'close', 'path': 'route', 'upstream': 'select_queue_conflict_outcome'}
