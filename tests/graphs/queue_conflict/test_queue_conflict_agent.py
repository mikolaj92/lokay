"""queue_conflict_agent in queue_conflict: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'queue_conflict'
_NODE_ID = 'queue_conflict_agent'
_ATOM = 'queue_conflict_agent'
_CONDUCTION = ['select_queue_conflict_gate']
_WHEN = {'equals': 'agent', 'path': 'route', 'upstream': 'select_queue_conflict_gate'}
