"""classify_ticket_scope_extra in assert_real_diff_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'assert_real_diff_execution'
_NODE_ID = 'classify_ticket_scope_extra'
_ATOM = 'classify_ticket_scope_extra'
_CONDUCTION = ['read_real_diff_paths', 'read_real_diff_issue_scope', 'classify_ticket_scope_presence']
_WHEN = None
