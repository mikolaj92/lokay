"""classify_real_diff_kind in assert_real_diff_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'assert_real_diff_execution'
_NODE_ID = 'classify_real_diff_kind'
_ATOM = 'classify_real_diff_kind'
_CONDUCTION = ['read_real_diff_paths']
_WHEN = None
