"""inspect_real_diff_worktree in assert_real_diff_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'assert_real_diff_execution'
_NODE_ID = 'inspect_real_diff_worktree'
_ATOM = 'inspect_real_diff_worktree'
_CONDUCTION = []
_WHEN = None
