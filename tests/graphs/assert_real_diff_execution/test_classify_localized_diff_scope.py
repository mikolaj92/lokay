"""classify_localized_diff_scope in assert_real_diff_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'assert_real_diff_execution'
_NODE_ID = 'classify_localized_diff_scope'
_ATOM = 'classify_localized_diff_scope'
_CONDUCTION = ['read_real_diff_paths', 'read_real_diff_localize_scope', 'classify_ticket_scope_extra']
_WHEN = None
