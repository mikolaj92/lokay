"""read_real_diff_issue_scope in assert_real_diff_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'assert_real_diff_execution'
_NODE_ID = 'read_real_diff_issue_scope'
_ATOM = 'read_real_diff_issue_scope'
_CONDUCTION = []
_WHEN = None
