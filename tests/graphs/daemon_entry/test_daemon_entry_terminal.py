"""daemon_entry_terminal in daemon_entry: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'daemon_entry'
_NODE_ID = 'daemon_entry_terminal'
_ATOM = 'daemon_entry_terminal'
_CONDUCTION = ['classify_daemon_preflight', 'run_daemon_product_cycle', 'run_initial_self_repair']
_WHEN = None
