"""run_daemon_product_cycle in daemon_entry: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'daemon_entry'
_NODE_ID = 'run_daemon_product_cycle'
_ATOM = 'run_daemon_product_cycle'
_CONDUCTION = ['classify_daemon_preflight']
_WHEN = {'equals': 'product', 'path': 'route', 'upstream': 'classify_daemon_preflight'}
