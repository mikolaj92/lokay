"""select_issue_triage_department in factory_pass: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_pass'
_NODE_ID = 'select_issue_triage_department'
_ATOM = 'select_issue_triage_department'
_CONDUCTION = ['factory_begin_host_gate', 'factory_begin', 'select_self_repair_department']
_WHEN = None
