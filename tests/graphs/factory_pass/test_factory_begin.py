"""factory_begin in factory_pass: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_pass'
_NODE_ID = 'factory_begin'
_ATOM = 'factory_begin'
_CONDUCTION = ['factory_begin_host_gate']
_WHEN = {'equals': 'begin', 'path': 'route', 'upstream': 'factory_begin_host_gate'}
