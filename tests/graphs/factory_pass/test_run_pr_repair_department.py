"""run_pr_repair_department in factory_pass: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_pass'
_NODE_ID = 'run_pr_repair_department'
_ATOM = 'run_pr_repair_department'
_CONDUCTION = ['select_pr_repair_department']
_WHEN = {'equals': 'repair', 'path': 'route', 'upstream': 'select_pr_repair_department'}
