"""run_self_repair_department in factory_pass: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_pass'
_NODE_ID = 'run_self_repair_department'
_ATOM = 'run_self_repair_department'
_CONDUCTION = ['select_self_repair_department']
_WHEN = {'equals': 'run', 'path': 'route', 'upstream': 'select_self_repair_department'}
