"""select_executor_department in factory_pass: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_pass'
_NODE_ID = 'select_executor_department'
_ATOM = 'select_executor_department'
_CONDUCTION = ['factory_begin_host_gate', 'factory_begin', 'select_issue_triage_department', 'run_issue_triage_department']
_WHEN = None
