"""run_executor_department in factory_pass: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_pass'
_NODE_ID = 'run_executor_department'
_ATOM = 'run_executor_department'
_CONDUCTION = ['select_executor_department',
 'factory_begin',
 'run_issue_triage_department',
 'select_issue_triage_department']
_WHEN = {'equals': 'run', 'path': 'route', 'upstream': 'select_executor_department'}
