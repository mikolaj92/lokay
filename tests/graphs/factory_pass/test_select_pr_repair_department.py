"""select_pr_repair_department in factory_pass: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_pass'
_NODE_ID = 'select_pr_repair_department'
_ATOM = 'select_pr_repair_department'
_CONDUCTION = ['factory_begin_host_gate', 'factory_begin', 'select_pr_triage_department', 'run_pr_triage_department']
_WHEN = None
