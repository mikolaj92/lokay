"""factory_pass_terminal in factory_pass: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_pass'
_NODE_ID = 'factory_pass_terminal'
_ATOM = 'factory_pass_terminal'
_CONDUCTION = ['record_pass']
_WHEN = None
