"""summarize_triage_dispatch in triage_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'triage_dispatch'
_NODE_ID = 'summarize_triage_dispatch'
_ATOM = 'summarize_triage_dispatch'
_CONDUCTION = ['record_triage_dispatch']
_WHEN = None
