"""check_triage_stuck in triage_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'triage_dispatch'
_NODE_ID = 'check_triage_stuck'
_ATOM = 'check_triage_stuck'
_CONDUCTION = ['select_triage_target']
_WHEN = {'equals': 'target', 'path': 'route', 'upstream': 'select_triage_target'}
