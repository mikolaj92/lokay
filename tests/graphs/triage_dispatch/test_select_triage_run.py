"""select_triage_run in triage_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'triage_dispatch'
_NODE_ID = 'select_triage_run'
_ATOM = 'select_triage_run'
_CONDUCTION = ['select_triage_gate', 'run_issue_triage_subflow']
_WHEN = None
