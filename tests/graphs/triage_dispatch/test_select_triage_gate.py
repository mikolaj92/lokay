"""select_triage_gate in triage_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'triage_dispatch'
_NODE_ID = 'select_triage_gate'
_ATOM = 'select_triage_gate'
_CONDUCTION = ['select_triage_target', 'check_triage_stuck']
_WHEN = None
