"""record_triage_dispatch in triage_dispatch: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'triage_dispatch'
_NODE_ID = 'record_triage_dispatch'
_ATOM = 'record_triage_dispatch'
_CONDUCTION = ['select_triage_run']
_WHEN = None
