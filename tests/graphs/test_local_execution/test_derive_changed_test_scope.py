"""derive_changed_test_scope in test_local_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'test_local_execution'
_NODE_ID = 'derive_changed_test_scope'
_ATOM = 'derive_changed_test_scope'
_CONDUCTION = ['inspect_test_declaration', 'select_declared_test_outcome']
_WHEN = None
