"""build_test_terminal_green in test_local_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'test_local_execution'
_NODE_ID = 'build_test_terminal_green'
_ATOM = 'build_test_terminal_green'
...
_WHEN = {'equals': 'green', 'path': 'kind', 'upstream': 'classify_test_terminal'}
