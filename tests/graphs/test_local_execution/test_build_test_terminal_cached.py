"""build_test_terminal_cached in test_local_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'test_local_execution'
_NODE_ID = 'build_test_terminal_cached'
_ATOM = 'build_test_terminal_cached'
...
_WHEN = {'equals': 'cached', 'path': 'kind', 'upstream': 'classify_test_terminal'}
