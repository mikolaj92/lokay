"""run_changed_scope_tests in test_local_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'test_local_execution'
_NODE_ID = 'run_changed_scope_tests'
_ATOM = 'run_changed_scope_tests'
_CONDUCTION = ['inspect_test_declaration', 'derive_changed_test_scope']
_WHEN = {'equals': 'scope', 'path': 'route', 'upstream': 'derive_changed_test_scope'}
