"""build_test_terminal_red in test_local_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'test_local_execution'
_NODE_ID = 'build_test_terminal_red'
_ATOM = 'build_test_terminal_red'
...
_WHEN = {'equals': 'red', 'path': 'kind', 'upstream': 'classify_test_terminal'}
