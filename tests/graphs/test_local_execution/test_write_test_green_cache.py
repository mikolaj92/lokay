"""write_test_green_cache in test_local_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'test_local_execution'
_NODE_ID = 'write_test_green_cache'
_ATOM = 'write_test_green_cache'
_CONDUCTION = ['inspect_test_declaration', 'read_test_green_cache', 'select_green_test_result']
_WHEN = None
