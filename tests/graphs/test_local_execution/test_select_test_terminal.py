"""select_test_terminal in test_local_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'test_local_execution'
_NODE_ID = 'select_test_terminal'
_ATOM = 'select_test_terminal'
_CONDUCTION = ['build_test_terminal_inspection',
