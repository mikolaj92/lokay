"""select_green_test_result in test_local_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'test_local_execution'
_NODE_ID = 'select_green_test_result'
_ATOM = 'select_green_test_result'
_CONDUCTION = ['run_declared_tests', 'run_changed_scope_tests']
_WHEN = None
