"""run_declared_tests in test_local_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'test_local_execution'
_NODE_ID = 'run_declared_tests'
_ATOM = 'run_declared_tests'
_CONDUCTION = ['inspect_test_declaration', 'read_test_green_cache']
_WHEN = {'equals': 'miss', 'path': 'route', 'upstream': 'read_test_green_cache'}
