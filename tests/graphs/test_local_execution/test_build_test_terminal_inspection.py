"""build_test_terminal_inspection in test_local_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'test_local_execution'
_NODE_ID = 'build_test_terminal_inspection'
_ATOM = 'build_test_terminal_inspection'
_CONDUCTION = ['inspect_test_declaration',
 'read_test_green_cache',
 'run_declared_tests',
 'run_changed_scope_tests',
 'write_test_green_cache',
 'classify_test_terminal']
_WHEN = {'equals': 'inspection', 'path': 'kind', 'upstream': 'classify_test_terminal'}
