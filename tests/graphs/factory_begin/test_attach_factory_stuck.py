"""attach_factory_stuck in factory_begin: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_begin'
_NODE_ID = 'attach_factory_stuck'
_ATOM = 'attach_factory_stuck'
_CONDUCTION = ['build_factory_begin_state', 'seed_factory_occupancy', 'read_factory_stuck']
_WHEN = None
