"""create_factory_pass_dir in factory_begin: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_begin'
_NODE_ID = 'create_factory_pass_dir'
_ATOM = 'create_factory_pass_dir'
_CONDUCTION = ['load_factory_config', 'select_factory_scope']
_WHEN = None
