"""persist_factory_tick in factory_begin: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_begin'
_NODE_ID = 'persist_factory_tick'
_ATOM = 'persist_factory_tick'
_CONDUCTION = ['probe_factory_host',
 'read_factory_stuck',
