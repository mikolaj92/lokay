"""seed_factory_occupancy in factory_begin: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_begin'
_NODE_ID = 'seed_factory_occupancy'
_ATOM = 'seed_factory_occupancy'
_CONDUCTION = ['build_factory_working_state']
_WHEN = None
