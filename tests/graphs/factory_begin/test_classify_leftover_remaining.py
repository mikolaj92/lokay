"""classify_leftover_remaining in factory_begin: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_begin'
_NODE_ID = 'classify_leftover_remaining'
_ATOM = 'classify_leftover_remaining'
_CONDUCTION = ['persist_factory_tick']
_WHEN = None
