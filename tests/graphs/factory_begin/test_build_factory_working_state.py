"""build_factory_working_state in factory_begin: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_begin'
_NODE_ID = 'build_factory_working_state'
_ATOM = 'build_factory_working_state'
_CONDUCTION = ['read_factory_stuck']
_WHEN = None
