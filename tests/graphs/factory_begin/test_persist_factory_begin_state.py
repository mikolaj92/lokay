"""persist_factory_begin_state in factory_begin: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_begin'
_NODE_ID = 'persist_factory_begin_state'
_ATOM = 'persist_factory_begin_state'
_CONDUCTION = ['create_factory_pass_dir', 'attach_factory_stuck']
_WHEN = None
