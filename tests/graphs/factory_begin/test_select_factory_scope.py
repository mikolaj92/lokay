"""select_factory_scope in factory_begin: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'factory_begin'
_NODE_ID = 'select_factory_scope'
_ATOM = 'select_factory_scope'
_CONDUCTION = ['load_factory_config']
_WHEN = None
