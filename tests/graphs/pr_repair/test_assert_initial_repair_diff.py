"""assert_initial_repair_diff in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'assert_initial_repair_diff'
_ATOM = 'assert_real_diff'
_CONDUCTION = ['worktree_add', 'finalize_repair_result', 'relocalize_initial_repair']
_WHEN = {'equals': 'repaired', 'path': 'route', 'upstream': 'finalize_repair_result'}
