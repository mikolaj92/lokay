"""select_repair_test in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'select_repair_test'
_ATOM = 'select_repair_test'
_CONDUCTION = ['test_local', 'finalize_repair_result']
_WHEN = None
