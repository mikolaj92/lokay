"""pr_repair_terminal in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'pr_repair_terminal'
_ATOM = 'pr_repair_terminal'
_CONDUCTION = ['finalize_repair_tests']
_WHEN = {'equals': 'terminal', 'path': 'route', 'upstream': 'finalize_repair_tests'}
