"""validate_repair_retry in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'validate_repair_retry'
_ATOM = 'validate_repair_retry'
_CONDUCTION = ['validate_initial_repair', 'pr_repair_retry_agent']
_WHEN = {'equals': 'retry', 'path': 'route', 'upstream': 'validate_initial_repair'}
