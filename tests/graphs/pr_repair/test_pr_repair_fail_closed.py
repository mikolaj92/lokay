"""pr_repair_fail_closed in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'pr_repair_fail_closed'
_ATOM = 'pr_repair_fail_closed'
_CONDUCTION = ['finalize_repair_result']
_WHEN = {'equals': 'fail_closed', 'path': 'route', 'upstream': 'finalize_repair_result'}
