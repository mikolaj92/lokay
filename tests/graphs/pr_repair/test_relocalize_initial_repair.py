"""relocalize_initial_repair in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'relocalize_initial_repair'
_ATOM = 'relocalize_off_goal'
_CONDUCTION = ['worktree_add', 'finalize_repair_result']
