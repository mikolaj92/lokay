"""validate_evidence_repair in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'validate_evidence_repair'
_ATOM = 'validate_evidence_repair'
_CONDUCTION = ['select_initial_repair', 'evidence_repair_agent']
_WHEN = {'equals': 'evidence', 'path': 'route', 'upstream': 'select_initial_repair'}
