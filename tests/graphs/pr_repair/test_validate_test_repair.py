"""validate_test_repair in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'validate_test_repair'
_ATOM = 'validate_test_repair'
_CONDUCTION = ['select_repair_test', 'pr_test_repair_agent']
