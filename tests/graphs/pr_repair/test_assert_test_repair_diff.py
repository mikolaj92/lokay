"""assert_test_repair_diff in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'assert_test_repair_diff'
_ATOM = 'assert_real_diff'
_CONDUCTION = ['worktree_add', 'select_test_repair_result', 'relocalize_test_repair']
