"""collect_repair_changed_files in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'collect_repair_changed_files'
_ATOM = 'collect_repair_changed_files'
_CONDUCTION = ['worktree_add', 'select_initial_repair']
_WHEN = {'equals': 'changed_files', 'path': 'evidence_kind', 'upstream': 'select_initial_repair'}
