"""finalize_repair_result in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'finalize_repair_result'
_ATOM = 'finalize_repair_result'
_CONDUCTION = ['worktree_add', 'select_initial_repair', 'select_evidence_repair']
