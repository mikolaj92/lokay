"""pr_test_repair_agent in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'pr_test_repair_agent'
_ATOM = 'pr_test_repair_agent'
_CONDUCTION = ['worktree_add', 'test_local', 'select_repair_test']
_WHEN = {'equals': 'fail', 'path': 'route', 'upstream': 'select_repair_test'}
