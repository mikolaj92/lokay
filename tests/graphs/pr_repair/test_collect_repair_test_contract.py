"""collect_repair_test_contract in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'collect_repair_test_contract'
_ATOM = 'collect_repair_test_contract'
_CONDUCTION = ['worktree_add', 'select_initial_repair']
_WHEN = {'equals': 'test_contract', 'path': 'evidence_kind', 'upstream': 'select_initial_repair'}
