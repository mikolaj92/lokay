"""select_evidence_repair in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'select_evidence_repair'
_ATOM = 'select_evidence_repair'
_CONDUCTION = ['select_initial_repair', 'validate_evidence_repair']
_WHEN = None
