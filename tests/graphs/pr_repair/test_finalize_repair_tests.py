"""finalize_repair_tests in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'finalize_repair_tests'
_ATOM = 'finalize_repair_tests'
_CONDUCTION = ['finalize_repair_result', 'select_repair_test', 'select_repair_test_recheck']
_WHEN = None
