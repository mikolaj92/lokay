"""select_initial_repair in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'select_initial_repair'
_ATOM = 'select_initial_repair'
_CONDUCTION = ['worktree_add', 'validate_initial_repair', 'validate_repair_retry']
_WHEN = {'equals': 'ready', 'path': 'route', 'upstream': 'worktree_add'}
_REQUIRED_WHEN_FIELDS = ['evidence_kind', 'route']
