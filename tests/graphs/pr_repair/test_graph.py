...
_EFFECTORS = [{'conduction': [], 'id': 'admit_pr_repair', 'when': None},
 ...
 {'conduction': ['worktree_add',
  ...
  'id': 'push',
  'when': {'equals': 'checkpointed', 'path': 'route', 'upstream': 'checkpoint_repair_publication'}},
 {'conduction': ['worktree_add',
                 'commit_initial_repair',
                 'commit_test_repair',
                 'test_local',
                 ...
                 'finalize_repair_tests',
                 'assert_real_diff'],
  'id': 'checkpoint_repair_publication',
  'when': {'equals': 'publish', 'path': 'route', 'upstream': 'finalize_repair_tests'}},
 {'conduction': ['admit_pr_repair',
  ...
  'when': None}]
_MATCH = {'checkpoint_repair_publication': {'route': 'checkpointed'},
 'finalize_repair_result': {'route': 'repaired'},
 'finalize_repair_tests': {'route': 'publish'},
 'localize': {'route': 'ready'},
 'select_initial_repair': {'evidence_kind': 'review_findings', 'route': 'evidence'},
...
_MISS = {'checkpoint_repair_publication': {'route': 'not-checkpointed'},
 'finalize_repair_result': {'route': 'not-repaired'},
 'finalize_repair_tests': {'route': 'not-publish'},
 'localize': {'route': 'not-ready'},
 'select_initial_repair': {'evidence_kind': 'not-review_findings', 'route': 'not-evidence'},
