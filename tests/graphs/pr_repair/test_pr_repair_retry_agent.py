"""pr_repair_retry_agent in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'pr_repair_retry_agent'
_ATOM = 'pr_repair_retry_agent'
_CONDUCTION = ['worktree_add', 'validate_initial_repair']
