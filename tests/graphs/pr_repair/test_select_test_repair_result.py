"""select_test_repair_result in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'select_test_repair_result'
_ATOM = 'select_test_repair_result'
_CONDUCTION = ['select_repair_test', 'validate_test_repair']
_WHEN = None
