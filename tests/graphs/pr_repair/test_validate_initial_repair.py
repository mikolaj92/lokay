"""validate_initial_repair in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'validate_initial_repair'
_ATOM = 'validate_initial_repair'
_CONDUCTION = ['worktree_add', 'run_agent']
