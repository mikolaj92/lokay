"""collect_repair_pr_metadata in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'collect_repair_pr_metadata'
_ATOM = 'collect_repair_pr_metadata'
_CONDUCTION = ['worktree_add', 'select_initial_repair']
_WHEN = {'equals': 'pr_metadata', 'path': 'evidence_kind', 'upstream': 'select_initial_repair'}
