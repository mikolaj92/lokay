"""select_repair_test_recheck in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'select_repair_test_recheck'
_ATOM = 'select_repair_test_recheck'
_CONDUCTION = ['select_test_repair_result', 'test_local_recheck']
_WHEN = None
