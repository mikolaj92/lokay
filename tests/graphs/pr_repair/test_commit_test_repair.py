"""commit_test_repair in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'commit_test_repair'
_ATOM = 'commit_all'
_CONDUCTION = ['worktree_add', 'select_test_repair_result', 'assert_test_repair_diff']
