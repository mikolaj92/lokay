"""collect_repair_review_findings in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'collect_repair_review_findings'
_ATOM = 'collect_repair_review_findings'
_CONDUCTION = ['worktree_add', 'select_initial_repair']
_WHEN = {'equals': 'review_findings', 'path': 'evidence_kind', 'upstream': 'select_initial_repair'}
