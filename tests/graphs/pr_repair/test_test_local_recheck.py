"""test_local_recheck in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'test_local_recheck'
_ATOM = 'test_local'
_CONDUCTION = ['worktree_add', 'commit_test_repair', 'select_test_repair_result']
