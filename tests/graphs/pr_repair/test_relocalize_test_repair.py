"""relocalize_test_repair in pr_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_repair'
_NODE_ID = 'relocalize_test_repair'
_ATOM = 'relocalize_off_goal'
_CONDUCTION = ['worktree_add', 'select_test_repair_result']
_WHEN = {'equals': 'repaired', 'path': 'route', 'upstream': 'select_test_repair_result'}
