"""collect_coding_test_contract in coding_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'coding_execution'
_NODE_ID = 'collect_coding_test_contract'
_ATOM = 'collect_coding_test_contract'
_CONDUCTION = ['prepare_coding_request', 'select_coding_result']
_WHEN = {'equals': 'test_contract', 'path': 'evidence_kind', 'upstream': 'select_coding_result'}
