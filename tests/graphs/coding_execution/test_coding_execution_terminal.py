"""coding_execution_terminal in coding_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'coding_execution'
_NODE_ID = 'coding_execution_terminal'
_ATOM = 'coding_execution_terminal'
_CONDUCTION = ['finalize_coding_result', 'coding_fail_closed']
_WHEN = None
