"""collect_coding_localized_diff in coding_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'coding_execution'
_NODE_ID = 'collect_coding_localized_diff'
_ATOM = 'collect_coding_localized_diff'
_CONDUCTION = ['prepare_coding_request', 'select_coding_result']
_WHEN = {'equals': 'localized_diff', 'path': 'evidence_kind', 'upstream': 'select_coding_result'}
