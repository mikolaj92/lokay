"""evidence_coding_agent in coding_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'coding_execution'
_NODE_ID = 'evidence_coding_agent'
_ATOM = 'evidence_coding_agent'
_CONDUCTION = ['prepare_coding_request',
