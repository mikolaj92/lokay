"""validate_coding_result in coding_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'coding_execution'
_NODE_ID = 'validate_coding_result'
_ATOM = 'validate_coding_result'
_CONDUCTION = ['run_agent']
_WHEN = None
