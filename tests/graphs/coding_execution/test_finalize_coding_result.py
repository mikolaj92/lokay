"""finalize_coding_result in coding_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'coding_execution'
_NODE_ID = 'finalize_coding_result'
_ATOM = 'finalize_coding_result'
_CONDUCTION = ['select_coding_result', 'select_evidence_coding']
_WHEN = None
