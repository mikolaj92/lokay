"""collect_coding_issue_snapshot in coding_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'coding_execution'
_NODE_ID = 'collect_coding_issue_snapshot'
_ATOM = 'collect_coding_issue_snapshot'
_CONDUCTION = ['prepare_coding_request', 'select_coding_result']
_WHEN = {'equals': 'issue_snapshot', 'path': 'evidence_kind', 'upstream': 'select_coding_result'}
