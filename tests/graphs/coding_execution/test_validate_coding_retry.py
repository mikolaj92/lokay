"""validate_coding_retry in coding_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'coding_execution'
_NODE_ID = 'validate_coding_retry'
_ATOM = 'validate_coding_retry'
_CONDUCTION = ['validate_coding_result', 'coding_retry_agent']
