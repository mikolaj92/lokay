"""validate_evidence_coding in coding_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'coding_execution'
_NODE_ID = 'validate_evidence_coding'
_ATOM = 'validate_evidence_coding'
_CONDUCTION = ['select_coding_result', 'evidence_coding_agent']
_WHEN = {'equals': 'evidence', 'path': 'route', 'upstream': 'select_coding_result'}
