"""coding_fail_closed in coding_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'coding_execution'
_NODE_ID = 'coding_fail_closed'
_ATOM = 'coding_fail_closed'
_CONDUCTION = ['finalize_coding_result']
_WHEN = {'equals': 'fail_closed', 'path': 'route', 'upstream': 'finalize_coding_result'}
