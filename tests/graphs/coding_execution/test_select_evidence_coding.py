"""select_evidence_coding in coding_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'coding_execution'
_NODE_ID = 'select_evidence_coding'
_ATOM = 'select_evidence_coding'
_CONDUCTION = ['select_coding_result', 'validate_evidence_coding']
_WHEN = None
