"""select_coding_result in coding_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'coding_execution'
_NODE_ID = 'select_coding_result'
_ATOM = 'select_coding_result'
_CONDUCTION = ['validate_coding_result', 'validate_coding_retry']
_WHEN = None
