"""summarize_issue_triage_department in issue_triage_department: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_triage_department'
_NODE_ID = 'summarize_issue_triage_department'
_ATOM = 'summarize_issue_triage_department'
_CONDUCTION = ['list_open_issues', 'run_issue_sieve_rows']
_WHEN = None
