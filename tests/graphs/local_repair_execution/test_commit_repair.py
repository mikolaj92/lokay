"""commit_repair in local_repair_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'local_repair_execution'
_NODE_ID = 'commit_repair'
_ATOM = 'commit_all'
_CONDUCTION = ['prepare_local_repair_request', 'select_repair_result', 'assert_repair_diff']
_WHEN = {'equals': 'repaired', 'path': 'route', 'upstream': 'select_repair_result'}
