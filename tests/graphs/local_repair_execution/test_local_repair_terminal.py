"""local_repair_terminal in local_repair_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'local_repair_execution'
_NODE_ID = 'local_repair_terminal'
_ATOM = 'local_repair_terminal'
_CONDUCTION = ['select_repair_result', 'select_local_test_recheck']
_WHEN = None
