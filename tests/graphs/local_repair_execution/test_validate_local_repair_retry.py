"""validate_local_repair_retry in local_repair_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'local_repair_execution'
_NODE_ID = 'validate_local_repair_retry'
_ATOM = 'validate_local_repair_retry'
_CONDUCTION = ['validate_repair_result', 'local_repair_retry_agent']
_WHEN = {'equals': 'retry', 'path': 'route', 'upstream': 'validate_repair_result'}
