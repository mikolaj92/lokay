"""assert_repair_diff in local_repair_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'local_repair_execution'
_NODE_ID = 'assert_repair_diff'
_ATOM = 'assert_real_diff'
_CONDUCTION = ['prepare_local_repair_request', 'select_repair_result']
