"""local_repair_retry_agent in local_repair_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'local_repair_execution'
_NODE_ID = 'local_repair_retry_agent'
_ATOM = 'local_repair_retry_agent'
_CONDUCTION = ['prepare_local_repair_request', 'validate_repair_result']
