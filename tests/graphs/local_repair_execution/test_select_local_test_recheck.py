"""select_local_test_recheck in local_repair_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'local_repair_execution'
_NODE_ID = 'select_local_test_recheck'
_ATOM = 'select_local_test_recheck'
_CONDUCTION = ['test_local_recheck', 'select_repair_result']
_WHEN = None
