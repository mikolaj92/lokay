"""prepare_local_repair_request in local_repair_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'local_repair_execution'
_NODE_ID = 'prepare_local_repair_request'
_ATOM = 'prepare_local_repair_request'
_CONDUCTION = []
_WHEN = None
