"""select_repair_result in local_repair_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'local_repair_execution'
_NODE_ID = 'select_repair_result'
_ATOM = 'select_repair_result'
_CONDUCTION = ['validate_repair_result', 'validate_local_repair_retry']
_WHEN = None
