"""create_issue_split_child_3 in issue_split: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_split'
_NODE_ID = 'create_issue_split_child_3'
_ATOM = 'create_issue_split_child_3'
_CONDUCTION = ['get_issue', 'plan_issue_split', 'create_issue_split_child_2']
_WHEN = {'equals': 'present', 'path': 'child_3', 'upstream': 'plan_issue_split'}
