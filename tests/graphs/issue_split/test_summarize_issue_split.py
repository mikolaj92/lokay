"""summarize_issue_split in issue_split: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_split'
_NODE_ID = 'summarize_issue_split'
_ATOM = 'summarize_issue_split'
_CONDUCTION = ['plan_issue_split', 'comment_issue_tracker', 'close_issue_tracker', 'select_park_stop', 'apply_issue_manual']
_WHEN = None
