"""close_issue_tracker in issue_split: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_split'
_NODE_ID = 'close_issue_tracker'
_ATOM = 'close_issue_tracker'
_CONDUCTION = ['get_issue', 'plan_issue_split', 'comment_issue_tracker']
_WHEN = {'equals': 'children', 'path': 'route', 'upstream': 'plan_issue_split'}
