"""create_issue_split_child_1 in issue_split: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_split'
_NODE_ID = 'create_issue_split_child_1'
_ATOM = 'create_issue_split_child_1'
_CONDUCTION = ['get_issue', 'plan_issue_split']
_WHEN = {'equals': 'present', 'path': 'child_1', 'upstream': 'plan_issue_split'}
