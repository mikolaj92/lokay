"""plan_issue_split in issue_split: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_split'
_NODE_ID = 'plan_issue_split'
_ATOM = 'plan_issue_split'
_CONDUCTION = ['get_issue']
_WHEN = None
_REQUIRED_WHEN_FIELDS = ['child_1', 'child_2', 'child_3', 'child_4', 'child_5', 'route']
