"""inspect_self_repair_changes in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'inspect_self_repair_changes'
_ATOM = 'inspect_self_repair_changes'
_CONDUCTION = ['select_self_repair_ownership_gate']
_WHEN = {'equals': 'owned', 'path': 'route', 'upstream': 'select_self_repair_ownership_gate'}
