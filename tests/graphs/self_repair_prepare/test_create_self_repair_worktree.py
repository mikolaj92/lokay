"""create_self_repair_worktree in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'create_self_repair_worktree'
_ATOM = 'create_self_repair_worktree'
_CONDUCTION = ['select_self_repair_remove_outcome']
_WHEN = {'equals': 'create_requested', 'path': 'route', 'upstream': 'select_self_repair_remove_outcome'}
