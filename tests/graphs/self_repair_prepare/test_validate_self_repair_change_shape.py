"""validate_self_repair_change_shape in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'validate_self_repair_change_shape'
_ATOM = 'validate_self_repair_change_shape'
_CONDUCTION = ['select_self_repair_changes_gate']
_WHEN = {'equals': 'changes', 'path': 'route', 'upstream': 'select_self_repair_changes_gate'}
