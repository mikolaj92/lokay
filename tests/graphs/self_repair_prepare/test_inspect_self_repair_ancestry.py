"""inspect_self_repair_ancestry in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'inspect_self_repair_ancestry'
_ATOM = 'inspect_self_repair_ancestry'
_CONDUCTION = ['select_self_repair_commit_validation_gate']
_WHEN = {'equals': 'ancestry', 'path': 'route', 'upstream': 'select_self_repair_commit_validation_gate'}
