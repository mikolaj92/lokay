"""select_self_repair_prepare_result in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'select_self_repair_prepare_result'
_ATOM = 'select_self_repair_prepare_result'
_CONDUCTION = ['resolve_self_repair_checkout',
