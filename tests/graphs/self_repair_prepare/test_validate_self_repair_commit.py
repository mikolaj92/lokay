"""validate_self_repair_commit in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'validate_self_repair_commit'
_ATOM = 'validate_self_repair_commit'
_CONDUCTION = ['select_self_repair_commit_gate']
_WHEN = {'equals': 'commit', 'path': 'route', 'upstream': 'select_self_repair_commit_gate'}
