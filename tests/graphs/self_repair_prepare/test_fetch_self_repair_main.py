"""fetch_self_repair_main in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'fetch_self_repair_main'
_ATOM = 'fetch_self_repair_main'
_CONDUCTION = ['select_self_repair_origin_gate']
_WHEN = {'equals': 'verified', 'path': 'route', 'upstream': 'select_self_repair_origin_gate'}
