"""resolve_self_repair_checkout in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'resolve_self_repair_checkout'
_ATOM = 'resolve_self_repair_checkout'
_CONDUCTION = []
_WHEN = None
