"""summarize_self_repair_prepare in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'summarize_self_repair_prepare'
_ATOM = 'summarize_self_repair_prepare'
_CONDUCTION = ['select_self_repair_prepare_result']
_WHEN = None
