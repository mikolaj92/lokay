"""read_self_repair_base in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'read_self_repair_base'
_ATOM = 'read_self_repair_base'
_CONDUCTION = ['select_self_repair_publish_gate']
_WHEN = {'equals': 'unpublished', 'path': 'route', 'upstream': 'select_self_repair_publish_gate'}
