"""select_self_repair_commit_validation_gate in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'select_self_repair_commit_validation_gate'
_ATOM = 'select_self_repair_commit_validation_gate'
_CONDUCTION = ['select_self_repair_commit_gate', 'validate_self_repair_commit']
_WHEN = None
