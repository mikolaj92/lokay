"""select_self_repair_fetch_gate in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'select_self_repair_fetch_gate'
_ATOM = 'select_self_repair_fetch_gate'
_CONDUCTION = ['select_self_repair_origin_gate', 'fetch_self_repair_main']
_WHEN = None
