"""check_self_repair_mutation_gate in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'check_self_repair_mutation_gate'
_ATOM = 'check_self_repair_mutation_gate'
