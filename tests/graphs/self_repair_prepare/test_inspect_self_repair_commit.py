"""inspect_self_repair_commit in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'inspect_self_repair_commit'
_ATOM = 'inspect_self_repair_commit'
_CONDUCTION = ['select_self_repair_shape_gate']
_WHEN = {'equals': 'commit_facts', 'path': 'route', 'upstream': 'select_self_repair_shape_gate'}
