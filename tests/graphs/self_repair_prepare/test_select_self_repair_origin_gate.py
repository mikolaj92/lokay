"""select_self_repair_origin_gate in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'select_self_repair_origin_gate'
_ATOM = 'select_self_repair_origin_gate'
_CONDUCTION = ['check_self_repair_mutation_gate', 'verify_self_repair_origin']
_WHEN = None
