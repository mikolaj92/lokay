"""select_self_repair_worktree_route in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'select_self_repair_worktree_route'
_ATOM = 'select_self_repair_worktree_route'
