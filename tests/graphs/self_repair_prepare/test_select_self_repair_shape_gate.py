"""select_self_repair_shape_gate in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'select_self_repair_shape_gate'
_ATOM = 'select_self_repair_shape_gate'
_CONDUCTION = ['select_self_repair_changes_gate', 'validate_self_repair_change_shape']
_WHEN = None
