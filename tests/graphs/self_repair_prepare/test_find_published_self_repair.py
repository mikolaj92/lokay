"""find_published_self_repair in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'find_published_self_repair'
_ATOM = 'find_published_self_repair'
_CONDUCTION = ['select_self_repair_fetch_gate']
_WHEN = {'equals': 'fetched', 'path': 'route', 'upstream': 'select_self_repair_fetch_gate'}
