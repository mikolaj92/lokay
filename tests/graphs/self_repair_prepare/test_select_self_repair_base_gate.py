"""select_self_repair_base_gate in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'select_self_repair_base_gate'
_ATOM = 'select_self_repair_base_gate'
_CONDUCTION = ['select_self_repair_publish_gate', 'read_self_repair_base']
_WHEN = None
