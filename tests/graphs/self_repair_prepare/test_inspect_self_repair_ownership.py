"""inspect_self_repair_ownership in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'inspect_self_repair_ownership'
_ATOM = 'inspect_self_repair_ownership'
_CONDUCTION = ['select_self_repair_base_gate']
_WHEN = {'equals': 'inspect', 'path': 'route', 'upstream': 'select_self_repair_base_gate'}
