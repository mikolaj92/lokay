"""remove_self_repair_worktree in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'remove_self_repair_worktree'
_ATOM = 'remove_self_repair_worktree'
_CONDUCTION = ['select_self_repair_worktree_route']
_WHEN = {'equals': 'remove', 'path': 'route', 'upstream': 'select_self_repair_worktree_route'}
