"""verify_self_repair_origin in self_repair_prepare: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_prepare'
_NODE_ID = 'verify_self_repair_origin'
_ATOM = 'verify_self_repair_origin'
_CONDUCTION = ['check_self_repair_mutation_gate']
_WHEN = {'equals': 'live', 'path': 'route', 'upstream': 'check_self_repair_mutation_gate'}
