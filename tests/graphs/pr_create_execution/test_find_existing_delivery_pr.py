"""find_existing_delivery_pr in pr_create_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_create_execution'
_NODE_ID = 'find_existing_delivery_pr'
_ATOM = 'find_existing_delivery_pr'
_CONDUCTION = ['prepare_pr_create_request']
_WHEN = None
