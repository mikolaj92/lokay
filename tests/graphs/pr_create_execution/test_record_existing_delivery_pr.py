"""record_existing_delivery_pr in pr_create_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_create_execution'
_NODE_ID = 'record_existing_delivery_pr'
_ATOM = 'record_existing_delivery_pr'
_CONDUCTION = ['find_existing_delivery_pr']
_WHEN = None
