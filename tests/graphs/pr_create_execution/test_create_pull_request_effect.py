"""create_pull_request_effect in pr_create_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_create_execution'
_NODE_ID = 'create_pull_request_effect'
_ATOM = 'create_pull_request_effect'
_CONDUCTION = ['prepare_pr_create_request', 'classify_pr_create_issue']
_WHEN = {'equals': 'create', 'path': 'route', 'upstream': 'classify_pr_create_issue'}
