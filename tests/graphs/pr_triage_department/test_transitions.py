...
_NODES = {'close_delivery_replay': {'atom': 'close_delivery_replay',
                           'conduction': ['select_pr_sieve', 'observe_delivery_replay'],
                           'when': {'equals': 'close',
                                    'path': 'route',
                                    'upstream': 'observe_delivery_replay'}},
 'list_pr_sieve': {'atom': 'list_pr_sieve', 'conduction': [], 'when': None},
 'observe_delivery_replay': {'atom': 'observe_delivery_replay',
                             'conduction': ['select_pr_sieve'],
                             'when': None},
 'publish_delivery_replay': {'atom': 'publish_delivery_replay',
                             'conduction': ['select_pr_sieve',
                                            'observe_delivery_replay',
                                            'close_delivery_replay'],
                             'when': {'equals': 'publish',
                                      'path': 'route',
                                      'upstream': 'close_delivery_replay'}},
...
_COND_EDGES = [('list_pr_sieve', 'select_pr_sieve'),
 ('select_pr_sieve', 'observe_delivery_replay'),
 ('select_pr_sieve', 'close_delivery_replay'),
 ('observe_delivery_replay', 'close_delivery_replay'),
 ('select_pr_sieve', 'publish_delivery_replay'),
 ('observe_delivery_replay', 'publish_delivery_replay'),
 ('close_delivery_replay', 'publish_delivery_replay'),
 ('select_pr_sieve', 'reconcile_pr_repair_push'),
 ('observe_delivery_replay', 'reconcile_pr_repair_push'),
 ...
 ('observe_delivery_replay', 'select_pr_triage_verdict'),
 ('close_delivery_replay', 'select_pr_triage_verdict'),
 ('publish_delivery_replay', 'select_pr_triage_verdict'),
 ...
 ('observe_delivery_replay', 'summarize_pr_triage_department'),
 ('close_delivery_replay', 'summarize_pr_triage_department'),
 ('publish_delivery_replay', 'summarize_pr_triage_department')]
_WHEN_BRANCHES = [('close_delivery_replay',
  {'equals': 'close', 'path': 'route', 'upstream': 'observe_delivery_replay'}),
 ('publish_delivery_replay',
  {'equals': 'publish', 'path': 'route', 'upstream': 'close_delivery_replay'}),
 ('recover_repair_pre_attempt',
