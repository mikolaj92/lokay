...
_NODE_ID = 'recover_repair_closed_merged'
_ATOM = 'recover_repair_closed_merged'
_CONDUCTION = ['reconcile_pr_repair_push']
_WHEN = {'equals': 'closed_merged', 'path': 'recovery_case', 'upstream': 'reconcile_pr_repair_push'}
