...
_NODE_ID = 'recover_repair_remote_unchanged'
_ATOM = 'recover_repair_remote_unchanged'
_CONDUCTION = ['reconcile_pr_repair_push']
_WHEN = {'equals': 'remote_unchanged', 'path': 'recovery_case', 'upstream': 'reconcile_pr_repair_push'}
