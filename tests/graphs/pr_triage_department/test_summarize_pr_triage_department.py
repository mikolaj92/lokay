"""summarize_pr_triage_department in pr_triage_department: graph metadata."""
from __future__ import annotations

_PATH_ID = 'pr_triage_department'
_NODE_ID = 'summarize_pr_triage_department'
_ATOM = 'summarize_pr_triage_department'
_CONDUCTION = ['select_pr_sieve', 'reconcile_pr_repair_push', 'run_pr_sieve', 'select_pr_triage_verdict']
_WHEN = None
