"""review_repair_gate in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'review_repair_gate'
_ATOM = 'review_repair_gate'
_CONDUCTION = ['classify_pr_triage_checks', 'publish_pr_review']
_WHEN = None
