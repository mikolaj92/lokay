"""select_pr_triage_outcome in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'select_pr_triage_outcome'
_ATOM = 'select_pr_triage_outcome'
_CONDUCTION = ['classify_pr_triage_checks', 'review_repair_gate', 'test_local']
_WHEN = None
