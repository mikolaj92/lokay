"""review_repair_manual in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'review_repair_manual'
_ATOM = 'review_repair_manual'
_CONDUCTION = ['publish_pr_review', 'review_repair_gate']
_WHEN = {'equals': 'fail_closed', 'path': 'route', 'upstream': 'review_repair_gate'}
