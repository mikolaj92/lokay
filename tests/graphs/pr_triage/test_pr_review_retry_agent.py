"""pr_review_retry_agent in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'pr_review_retry_agent'
_ATOM = 'pr_review_retry_agent'
_CONDUCTION = ['collect_pr_review_evidence', 'validate_pr_review']
