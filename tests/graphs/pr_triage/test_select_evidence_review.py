"""select_evidence_review in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'select_evidence_review'
_ATOM = 'select_evidence_review'
_CONDUCTION = ['classify_pr_triage_checks', 'select_pr_review', 'validate_evidence_review']
_WHEN = {'equals': 'review', 'path': 'route', 'upstream': 'classify_pr_triage_checks'}
...
_EFFECTORS = [{'conduction': [], 'id': 'pr_checks', 'when': None},
 ...
 {'conduction': ['classify_pr_triage_checks',
  ...
  'id': 'pr_review_agent',
  'when': {'equals': 'ready', 'path': 'route', 'upstream': 'select_pr_review_scope'}},
 {'conduction': ['classify_pr_triage_checks',
                 'resolve_sha_review',
                 'select_pr_review_scope',
                 'pr_review_agent'],
