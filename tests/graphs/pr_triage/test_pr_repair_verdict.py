"""pr_repair_verdict in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'pr_repair_verdict'
_ATOM = 'pr_repair_verdict'
_CONDUCTION = ['classify_pr_triage_checks', 'select_pr_triage_outcome', 'publish_pr_review']
_WHEN = {'equals': 'repair', 'path': 'route', 'upstream': 'select_pr_triage_outcome'}
