...
_EFFECTORS = [{'conduction': [], 'id': 'pr_checks', 'when': None},
 ...
 {'conduction': ['classify_pr_triage_checks', 'collect_pr_review_evidence', 'resolve_sha_review', 'select_pr_review_scope'],
  'id': 'pr_review_agent',
  'when': {'equals': 'ready', 'path': 'route', 'upstream': 'select_pr_review_scope'}},
 {'conduction': ['classify_pr_triage_checks', 'resolve_sha_review', 'select_pr_review_scope', 'pr_review_agent'],
...
_MATCH = {'classify_pr_triage_checks': {'route': 'review'},
 ...
 'select_pr_review_scope': {'route': 'ready'},
...
_MISS = {'classify_pr_triage_checks': {'route': 'not-review'},
 ...
 'select_pr_review_scope': {'route': 'not-ready'},
