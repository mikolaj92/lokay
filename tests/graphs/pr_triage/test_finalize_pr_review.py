"""finalize_pr_review in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'finalize_pr_review'
_ATOM = 'finalize_pr_review'
_CONDUCTION = ['classify_pr_triage_checks', 'select_pr_review', 'select_evidence_review']
