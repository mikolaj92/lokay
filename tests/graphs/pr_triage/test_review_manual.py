"""review_manual in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'review_manual'
_ATOM = 'review_manual'
_CONDUCTION = ['publish_pr_review']
_WHEN = {'equals': 'fail_closed', 'path': 'decision.verdict', 'upstream': 'publish_pr_review'}
