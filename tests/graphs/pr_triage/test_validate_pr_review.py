"""validate_pr_review in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'validate_pr_review'
_ATOM = 'validate_pr_review'
_CONDUCTION = ['classify_pr_triage_checks', 'resolve_sha_review', 'select_pr_review_scope', 'pr_review_agent']
_WHEN = None
