"""evidence_review_agent in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'evidence_review_agent'
_ATOM = 'evidence_review_agent'
_CONDUCTION = ['collect_pr_review_evidence', 'select_pr_review', 'review_evidence_catalog']
