"""collect_pr_review_evidence in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'collect_pr_review_evidence'
_ATOM = 'collect_pr_review_evidence'
_CONDUCTION = ['pr_checks', 'classify_pr_triage_checks']
