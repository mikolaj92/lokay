"""resolve_sha_review in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'resolve_sha_review'
_ATOM = 'resolve_sha_review'
_CONDUCTION = ['classify_pr_triage_checks', 'collect_pr_review_evidence']
_WHEN = None
