"""validate_evidence_review in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'validate_evidence_review'
_ATOM = 'validate_evidence_review'
_CONDUCTION = ['select_pr_review', 'review_evidence_catalog', 'evidence_review_agent']
_WHEN = {'equals': 'agent', 'path': 'route', 'upstream': 'review_evidence_catalog'}
