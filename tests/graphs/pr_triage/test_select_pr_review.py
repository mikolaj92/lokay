"""select_pr_review in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'select_pr_review'
_ATOM = 'select_pr_review'
_CONDUCTION = ['classify_pr_triage_checks', 'resolve_sha_review', 'validate_pr_review', 'validate_pr_review_retry']
_WHEN = None
