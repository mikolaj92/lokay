"""close_issue in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'close_issue'
_ATOM = 'close_issue'
_CONDUCTION = ['publish_pr_review', 'pr_merge', 'stage_clear', 'select_pr_triage_outcome']
