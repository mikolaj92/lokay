"""validate_pr_review_retry in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'validate_pr_review_retry'
_ATOM = 'validate_pr_review_retry'
_CONDUCTION = ['validate_pr_review', 'pr_review_retry_agent']
_WHEN = {'equals': 'retry', 'path': 'route', 'upstream': 'validate_pr_review'}
