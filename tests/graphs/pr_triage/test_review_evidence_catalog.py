"""review_evidence_catalog in pr_triage: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'pr_triage'
_NODE_ID = 'review_evidence_catalog'
_ATOM = 'review_evidence_catalog'
_CONDUCTION = ['classify_pr_triage_checks', 'collect_pr_review_evidence', 'select_pr_review']
_WHEN = {'equals': 'evidence', 'path': 'route', 'upstream': 'select_pr_review'}
