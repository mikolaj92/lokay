"""run_localization_agent in localize_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'localize_execution'
_NODE_ID = 'run_localization_agent'
_ATOM = 'run_localization_agent'
_CONDUCTION = ['prepare_localization_request', 'build_localization_agent_request']
_WHEN = {'equals': 'agent', 'path': 'route', 'upstream': 'build_localization_agent_request'}
