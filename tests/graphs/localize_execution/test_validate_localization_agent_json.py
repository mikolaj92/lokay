"""validate_localization_agent_json in localize_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'localize_execution'
_NODE_ID = 'validate_localization_agent_json'
_ATOM = 'validate_localization_agent_json'
_CONDUCTION = ['run_localization_agent']
_WHEN = None
