"""build_localization_agent_request in localize_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'localize_execution'
_NODE_ID = 'build_localization_agent_request'
_ATOM = 'build_localization_agent_request'
