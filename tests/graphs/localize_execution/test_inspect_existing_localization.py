"""inspect_existing_localization in localize_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'localize_execution'
_NODE_ID = 'inspect_existing_localization'
_ATOM = 'inspect_existing_localization'
