"""build_localization_retry in localize_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'localize_execution'
_NODE_ID = 'build_localization_retry'
_ATOM = 'build_localization_retry'
_CONDUCTION = ['validate_localization_agent_json']
_WHEN = None
