"""classify_localization_route in localize_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'localize_execution'
_NODE_ID = 'classify_localization_route'
_ATOM = 'classify_localization_route'
_CONDUCTION = ['prepare_localization_request', 'inspect_existing_localization']
_WHEN = None
