"""validate_localization_paths in localize_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'localize_execution'
_NODE_ID = 'validate_localization_paths'
_ATOM = 'validate_localization_paths'
