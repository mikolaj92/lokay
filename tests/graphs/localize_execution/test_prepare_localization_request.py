"""prepare_localization_request in localize_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'localize_execution'
_NODE_ID = 'prepare_localization_request'
_ATOM = 'prepare_localization_request'
_CONDUCTION = []
_WHEN = None
