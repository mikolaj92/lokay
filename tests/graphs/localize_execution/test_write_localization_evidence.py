"""write_localization_evidence in localize_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'localize_execution'
_NODE_ID = 'write_localization_evidence'
_ATOM = 'write_localization_evidence'
_CONDUCTION = ['prepare_localization_request', 'validate_localization_paths']
_WHEN = None
