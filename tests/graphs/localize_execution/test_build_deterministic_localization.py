"""build_deterministic_localization in localize_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'localize_execution'
_NODE_ID = 'build_deterministic_localization'
_ATOM = 'build_deterministic_localization'
_CONDUCTION = ['prepare_localization_request']
_WHEN = None
