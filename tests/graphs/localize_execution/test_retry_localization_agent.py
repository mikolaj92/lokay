"""retry_localization_agent in localize_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'localize_execution'
_NODE_ID = 'retry_localization_agent'
_ATOM = 'retry_localization_agent'
_CONDUCTION = ['prepare_localization_request', 'build_localization_agent_request', 'build_localization_retry']
_WHEN = {'equals': 'retry', 'path': 'route', 'upstream': 'build_localization_retry'}
