"""select_localization_candidate in localize_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'localize_execution'
_NODE_ID = 'select_localization_candidate'
_ATOM = 'select_localization_candidate'
_CONDUCTION = ['classify_localization_route',
