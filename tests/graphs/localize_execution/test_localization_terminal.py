"""localization_terminal in localize_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'localize_execution'
_NODE_ID = 'localization_terminal'
_ATOM = 'localization_terminal'
_CONDUCTION = ['select_localization_candidate', 'write_localization_evidence']
_WHEN = None
