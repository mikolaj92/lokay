"""self_repair_validate in self_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair'
_NODE_ID = 'self_repair_validate'
_ATOM = 'self_repair_validate'
_CONDUCTION = ['self_repair_prepare', 'self_repair_commit']
_WHEN = None
