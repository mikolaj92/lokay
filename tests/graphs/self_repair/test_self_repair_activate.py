"""self_repair_activate in self_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair'
_NODE_ID = 'self_repair_activate'
_ATOM = 'self_repair_activate'
_CONDUCTION = ['self_repair_push_main']
_WHEN = None
