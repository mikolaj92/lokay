"""self_repair_preflight in self_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair'
_NODE_ID = 'self_repair_preflight'
_ATOM = 'self_repair_preflight'
_CONDUCTION = ['self_repair_activate']
_WHEN = None
