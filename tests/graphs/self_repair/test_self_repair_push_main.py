"""self_repair_push_main in self_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair'
_NODE_ID = 'self_repair_push_main'
_ATOM = 'self_repair_push_main'
_CONDUCTION = ['self_repair_prepare', 'self_repair_validate', 'self_repair_commit']
_WHEN = None
