"""self_repair_run_agent in self_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair'
_NODE_ID = 'self_repair_run_agent'
_ATOM = 'self_repair_run_agent'
_CONDUCTION = ['self_repair_prepare']
_WHEN = None
