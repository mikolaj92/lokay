"""summarize_self_repair in self_repair: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair'
_NODE_ID = 'summarize_self_repair'
_ATOM = 'summarize_self_repair'
_CONDUCTION = ['self_repair_preflight', 'self_repair_push_main', 'self_repair_activate', 'self_repair_close']
_WHEN = None
