"""run_status_preflight in status_snapshot: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'status_snapshot'
_NODE_ID = 'run_status_preflight'
_ATOM = 'run_status_preflight'
_CONDUCTION = ['read_status_config']
_WHEN = {'equals': True, 'path': 'preflight_requested', 'upstream': 'read_status_config'}
