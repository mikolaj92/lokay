"""status_snapshot_terminal in status_snapshot: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'status_snapshot'
_NODE_ID = 'status_snapshot_terminal'
_ATOM = 'status_snapshot_terminal'
_CONDUCTION = ['reduce_status_snapshot']
_WHEN = None
