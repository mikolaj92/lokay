"""record_status_preflight in status_snapshot: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'status_snapshot'
_NODE_ID = 'record_status_preflight'
_ATOM = 'record_status_preflight'
_CONDUCTION = ['read_status_config', 'run_status_preflight']
_WHEN = None
