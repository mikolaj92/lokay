"""classify_executor_row_2 in executor_rows: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'executor_rows'
_NODE_ID = 'classify_executor_row_2'
_ATOM = 'classify_executor_row_2'
_CONDUCTION = ['prepare_executor_rows', 'select_executor_slot_2', 'run_executor_row_2', 'classify_executor_row_1']
_WHEN = None
