"""run_executor_row_1 in executor_rows: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'executor_rows'
_NODE_ID = 'run_executor_row_1'
_ATOM = 'run_executor_row_1'
_CONDUCTION = ['prepare_executor_rows', 'select_executor_slot_1']
_WHEN = {'equals': 'run', 'path': 'route', 'upstream': 'select_executor_slot_1'}
