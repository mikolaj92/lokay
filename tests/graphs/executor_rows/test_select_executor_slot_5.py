"""select_executor_slot_5 in executor_rows: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'executor_rows'
_NODE_ID = 'select_executor_slot_5'
_ATOM = 'select_executor_slot_5'
_CONDUCTION = ['prepare_executor_rows', 'classify_executor_row_4']
_WHEN = None
