"""classify_executor_row_7 in executor_rows: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'executor_rows'
_NODE_ID = 'classify_executor_row_7'
_ATOM = 'classify_executor_row_7'
_CONDUCTION = ['prepare_executor_rows', 'select_executor_slot_7', 'run_executor_row_7', 'classify_executor_row_6']
_WHEN = None
