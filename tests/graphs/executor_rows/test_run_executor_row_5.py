"""run_executor_row_5 in executor_rows: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'executor_rows'
_NODE_ID = 'run_executor_row_5'
_ATOM = 'run_executor_row_5'
_CONDUCTION = ['prepare_executor_rows', 'select_executor_slot_5', 'classify_executor_row_4']
_WHEN = {'equals': 'run', 'path': 'route', 'upstream': 'select_executor_slot_5'}
