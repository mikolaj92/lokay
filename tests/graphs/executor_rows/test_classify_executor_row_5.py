"""classify_executor_row_5 in executor_rows: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'executor_rows'
_NODE_ID = 'classify_executor_row_5'
_ATOM = 'classify_executor_row_5'
_CONDUCTION = ['prepare_executor_rows', 'select_executor_slot_5', 'run_executor_row_5', 'classify_executor_row_4']
_WHEN = None
