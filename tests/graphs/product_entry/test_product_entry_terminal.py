"""product_entry_terminal in product_entry: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'product_entry'
_NODE_ID = 'product_entry_terminal'
_ATOM = 'product_entry_terminal'
_CONDUCTION = ['classify_product_entry_preflight', 'run_product_entry_budget']
_WHEN = None
