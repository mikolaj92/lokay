"""select_issue_executor in executor_row: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'executor_row'
_NODE_ID = 'select_issue_executor'
_ATOM = 'select_issue_executor'
_CONDUCTION = ['select_issue_do_row']
_WHEN = None
