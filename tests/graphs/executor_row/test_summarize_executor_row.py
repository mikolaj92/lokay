"""summarize_executor_row in executor_row: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'executor_row'
_NODE_ID = 'summarize_executor_row'
_ATOM = 'summarize_executor_row'
_CONDUCTION = ['select_next_issue', 'select_issue_do_row', 'select_issue_executor', 'issues_launch_pr']
_WHEN = None
