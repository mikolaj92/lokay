"""issues_launch_pr in executor_row: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'executor_row'
_NODE_ID = 'issues_launch_pr'
_ATOM = 'issues_launch_pr'
_CONDUCTION = ['select_issue_executor']
_WHEN = {'equals': 'do', 'path': 'route', 'upstream': 'select_issue_executor'}
