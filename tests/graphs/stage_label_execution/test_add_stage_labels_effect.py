"""add_stage_labels_effect in stage_label_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'stage_label_execution'
_NODE_ID = 'add_stage_labels_effect'
_ATOM = 'add_stage_labels_effect'
_CONDUCTION = ['prepare_stage_transition', 'record_stage_removal']
_WHEN = None
