"""stage_label_terminal in stage_label_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'stage_label_execution'
_NODE_ID = 'stage_label_terminal'
_ATOM = 'stage_label_terminal'
_CONDUCTION = ['prepare_stage_transition',
 'read_stage_issue',
