"""record_stage_removal in stage_label_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'stage_label_execution'
_NODE_ID = 'record_stage_removal'
_ATOM = 'record_stage_removal'
_CONDUCTION = ['classify_stage_issue', 'remove_stage_labels_effect']
_WHEN = None
