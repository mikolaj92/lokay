"""comment_stage_receipt_effect in stage_label_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'stage_label_execution'
_NODE_ID = 'comment_stage_receipt_effect'
_ATOM = 'comment_stage_receipt_effect'
_CONDUCTION = ['prepare_stage_transition', 'add_stage_labels_effect']
_WHEN = {'equals': 'comment', 'path': 'route', 'upstream': 'add_stage_labels_effect'}
