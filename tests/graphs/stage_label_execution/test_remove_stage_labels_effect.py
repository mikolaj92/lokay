"""remove_stage_labels_effect in stage_label_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'stage_label_execution'
_NODE_ID = 'remove_stage_labels_effect'
_ATOM = 'remove_stage_labels_effect'
_CONDUCTION = ['prepare_stage_transition', 'classify_stage_issue']
_WHEN = {'equals': 'remove', 'path': 'route', 'upstream': 'classify_stage_issue'}
