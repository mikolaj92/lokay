"""read_activated_head in self_repair_activate_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_activate_execution'
_NODE_ID = 'read_activated_head'
_ATOM = 'read_activated_head'
_CONDUCTION = ['prepare_self_repair_activation', 'record_recovery_fast_forward']
_WHEN = {'equals': 'merged', 'path': 'route', 'upstream': 'record_recovery_fast_forward'}
