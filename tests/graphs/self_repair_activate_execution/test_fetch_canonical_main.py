"""fetch_canonical_main in self_repair_activate_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_activate_execution'
_NODE_ID = 'fetch_canonical_main'
_ATOM = 'fetch_canonical_main'
_CONDUCTION = ['prepare_self_repair_activation', 'classify_canonical_checkout']
_WHEN = {'equals': 'clean', 'path': 'route', 'upstream': 'classify_canonical_checkout'}
