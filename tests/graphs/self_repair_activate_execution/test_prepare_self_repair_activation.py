"""prepare_self_repair_activation in self_repair_activate_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_activate_execution'
_NODE_ID = 'prepare_self_repair_activation'
_ATOM = 'prepare_self_repair_activation'
_CONDUCTION = []
_WHEN = None
