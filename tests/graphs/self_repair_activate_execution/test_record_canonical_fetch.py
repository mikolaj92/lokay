"""record_canonical_fetch in self_repair_activate_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_activate_execution'
_NODE_ID = 'record_canonical_fetch'
_ATOM = 'record_canonical_fetch'
_CONDUCTION = ['classify_canonical_checkout', 'fetch_canonical_main']
_WHEN = None
