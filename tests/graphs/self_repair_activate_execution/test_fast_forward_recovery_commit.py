"""fast_forward_recovery_commit in self_repair_activate_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_activate_execution'
_NODE_ID = 'fast_forward_recovery_commit'
_ATOM = 'fast_forward_recovery_commit'
_CONDUCTION = ['prepare_self_repair_activation', 'record_canonical_fetch']
_WHEN = {'equals': 'fetched', 'path': 'route', 'upstream': 'record_canonical_fetch'}
