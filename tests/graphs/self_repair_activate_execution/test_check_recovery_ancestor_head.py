"""check_recovery_ancestor_head in self_repair_activate_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_activate_execution'
_NODE_ID = 'check_recovery_ancestor_head'
_ATOM = 'check_recovery_ancestor_head'
_CONDUCTION = ['prepare_self_repair_activation', 'classify_activated_head']
_WHEN = {'equals': 'ancestry', 'path': 'route', 'upstream': 'classify_activated_head'}
