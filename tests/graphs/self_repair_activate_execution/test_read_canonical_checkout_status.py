"""read_canonical_checkout_status in self_repair_activate_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_activate_execution'
_NODE_ID = 'read_canonical_checkout_status'
_ATOM = 'read_canonical_checkout_status'
_CONDUCTION = ['prepare_self_repair_activation']
_WHEN = {'equals': 'status', 'path': 'route', 'upstream': 'prepare_self_repair_activation'}
