"""check_dirty_commit_on_origin in self_repair_activate_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_activate_execution'
_NODE_ID = 'check_dirty_commit_on_origin'
_ATOM = 'check_dirty_commit_on_origin'
_CONDUCTION = ['prepare_self_repair_activation', 'classify_canonical_checkout']
_WHEN = {'equals': 'dirty', 'path': 'route', 'upstream': 'classify_canonical_checkout'}
