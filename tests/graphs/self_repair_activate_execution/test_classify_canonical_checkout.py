"""classify_canonical_checkout in self_repair_activate_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_activate_execution'
_NODE_ID = 'classify_canonical_checkout'
_ATOM = 'classify_canonical_checkout'
_CONDUCTION = ['prepare_self_repair_activation', 'read_canonical_checkout_status']
_WHEN = None
