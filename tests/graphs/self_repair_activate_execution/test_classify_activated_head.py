"""classify_activated_head in self_repair_activate_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_activate_execution'
_NODE_ID = 'classify_activated_head'
_ATOM = 'classify_activated_head'
