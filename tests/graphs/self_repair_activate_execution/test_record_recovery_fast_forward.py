"""record_recovery_fast_forward in self_repair_activate_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_activate_execution'
_NODE_ID = 'record_recovery_fast_forward'
_ATOM = 'record_recovery_fast_forward'
_CONDUCTION = ['record_canonical_fetch', 'fast_forward_recovery_commit']
_WHEN = None
