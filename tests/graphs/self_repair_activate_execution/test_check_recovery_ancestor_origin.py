"""check_recovery_ancestor_origin in self_repair_activate_execution: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'self_repair_activate_execution'
_NODE_ID = 'check_recovery_ancestor_origin'
_ATOM = 'check_recovery_ancestor_origin'
_CONDUCTION = ['prepare_self_repair_activation', 'classify_activated_head', 'record_recovery_head_ancestry']
_WHEN = {'equals': 'not_ancestor', 'path': 'route', 'upstream': 'record_recovery_head_ancestry'}
