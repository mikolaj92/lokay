"""issues_run_triage in issue_sieve_row: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_sieve_row'
_NODE_ID = 'issues_run_triage'
_ATOM = 'issues_run_triage'
_CONDUCTION = ['select_next_issue']
_WHEN = {'equals': 'issue', 'path': 'route', 'upstream': 'select_next_issue'}
