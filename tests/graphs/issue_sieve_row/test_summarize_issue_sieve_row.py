"""summarize_issue_sieve_row in issue_sieve_row: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_sieve_row'
_NODE_ID = 'summarize_issue_sieve_row'
_ATOM = 'summarize_issue_sieve_row'
_CONDUCTION = ['select_next_issue', 'issues_run_triage', 'select_issue_sieve', 'run_issue_sieve_split']
_WHEN = None
