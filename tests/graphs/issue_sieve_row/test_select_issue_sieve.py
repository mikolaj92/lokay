"""select_issue_sieve in issue_sieve_row: geometry and required when fields."""
from __future__ import annotations

_PATH_ID = 'issue_sieve_row'
_NODE_ID = 'select_issue_sieve'
_ATOM = 'select_issue_sieve'
_CONDUCTION = ['select_next_issue', 'issues_run_triage']
_WHEN = None
