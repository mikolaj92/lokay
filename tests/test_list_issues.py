...
def test_list_issues_still_lists_lokay(
    ...
    issue = SimpleNamespace(
        ...
        labels=[],
        assignees=[],
        url="https://github.com/mikolaj92/lokay/issues/455",
        state="OPEN",
        author="",
    )
    ...
    monkeypatch.setattr("lokay.github_tasks.list_issues_with_label", fake_label)
    ...
    assert payload["issues"][0]["number"] == 455
